...
function(a) {
            ...
            l[3] && (q = 60 * Number(l[5]) + Number(l[6]), q *= "-" === l[4] ? 1 : -1, q -= o.getTimezoneOffset(), o.setTime(Number(Number(o) + 60 * q * 1e3)));
                ...
                for ("ISO8601Long" === d.srcformat && "Z" === b.charAt(b.length - 1) && (q -= (new Date).getTimezoneOffset()), b = String(b).replace(/\T/g, "#").replace(/\t/, "%").split(d.parseRe), a = a.replace(/\T/g, "#").replace(/\t/, "%").split(d.parseRe), f = 0, g = a.length; f < g; f++) {
                    ...
                    case "a":
                        ...
                        -1 !== e && e < 2 && b[f] === d.AmPm[e] && (b[f] = e, n.h = p(b[f], n.h));
                        break;
                    case "A":
                        e = $.inArray(b[f], d.AmPm),
        ...
        from: function(source) {
            ...
            QueryObject = function(d, q) {
                ...
                this._compare = function(a, b, c) {
                    ...
                    void 0 === a && (a = null),
                    void 0 === b && (b = null),
                    null === a && null === b ? 0 : null === a && null !== b ? 1 : null !== a && null === b ? -1 : "[object Date]" === d.call(a) && "[object Date]" === d.call(b) ? a < b ? -c: a > b ? c: 0 : (_usecase || "number" == typeof a || "number" == typeof b || (a = String(a), b = String(b)), a < b ? -c: a > b ? c: 0)
                },
                ...
                this._getOrder = function(a, b, c, d, e, f) {
                    ...
                    i = 0;
                    for (var n = a.length; i < n;) g = l[i].index,
                    k.push(a[g]),
                    i++;
                    return k
                },
    ...
    $.fn.jqGrid = function(a) {
        ...
        return this.each(function() {
            function b(a, b, c, d) {
                ...
                else if (e.p.multiboxonly && e.p.multimail) $(e).triggerHandler("jqGridSelectRow", [a, !1, c]),
                e.p.onSelectRow && e.p.onSelectRow.call(e, a, !1, c);
                    ...
                    $(e.p.selarrrow).each(function(a, b) {
                        ...
                        f && ($("#" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f)).removeClass(o), $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + $.jgrid.jqID(b), "#" + $.jgrid.jqID(f))[e.p.useProp ? "prop": "attr"]("checked", !1))
                    }),
                    e.p.selarrrow = [],
            ...
            if (!this.grid) {
                ...
                f = {
                    ...
                    dragEnd: function(a) {
                        if (this.hDiv.style.cursor = "default", this.resizing) {
                            ...
                            !0 === d.forceFit ? (c = this.headers[b + d.nv].newWidth || this.headers[b + d.nv].width, this.headers[b + d.nv].width = c, this.headers[b + d.nv].el.style.width = c + "px", this.cols[b + d.nv].style.width = c + "px", this.footers.length > 0 && (this.footers[b + d.nv].style.width = c + "px"), d.colModel[b + d.nv].width = c) : (d.tblwidth = this.newWidth || d.tblwidth, $("table:first", this.bDiv).css("width", d.tblwidth + "px"), $("table:first", this.hDiv).css("width", d.tblwidth + "px"), this.hDiv.scrollLeft = this.bDiv.scrollLeft, d.footerrow && ($("table:first", this.sDiv).css("width", d.tblwidth + "px"), this.sDiv.scrollLeft = this.bDiv.scrollLeft)),
                            a && ($(e).triggerHandler("jqGridResizeStop", [c, b]), $.isFunction(d.resizeStop) && d.resizeStop.call(e, c, b))
                        }
                        this.curGbox = null,
                        document.onselectstart = function() {
                            return ! 0
                        ...
                        if (a) {
                            ...
                            if (c) {
                                ...
                                if (n < a && m <= 0 && (void 0 === d.lastpage || (parseInt((n + l + o - 1) / o, 10) || 0) <= d.lastpage) && (i = parseInt((a - n + o - 1) / o, 10) || 1, n >= 0 || i < 2 || !0 === d.scroll ? (h = (Math.round((n + l) / o) || 0) + 1, m = -1) : m = 1), m > 0 && (h = (parseInt(l / o, 10) || 0) + 1, i = (parseInt((l + a) / o, 10) || 0) + 2 - h, j = !0), i) {
                                    ...
                                    f.hDiv.loading ? f.timer = setTimeout(f.populateVisible, d.scrollTimeout) : (d.page = h, d.scrollMaxBuffer > 0 && (k > 0 && d.scrollMaxBuffer < k && (d.scrollMaxBuffer = k + 1), d.reccount > d.scrollMaxBuffer - (k > 0 ? k: 0) && (j = !0)), j && (f.selectionPreserver(g[0]), f.emptyRows.call(g[0], !1, !1)), f.populate(i)),
                    ...
                    scrollGrid: function(a) {
                        if (d.scroll) {
                            ...
                            b !== f.scrollTop && (f.scrollTop = b, f.timer && clearTimeout(f.timer), f.timer = setTimeout(f.populateVisible, d.scrollTimeout))
                        }
                ...
                w = [];
                m = e.p.styleUI + ".base",
                k = $("<div " + l(m, "viewBox", !1, "ui-jqgrid-view") + " role='grid'></div>"),
                ...
                $(k).attr("id", "gview_" + this.id).appendTo(x),
                $("<div " + l(e.p.styleUI + ".common", "overlay", !1, "jqgrid-overlay") + " id='lui_" + this.id + "'></div>").insertBefore(k),
                $("<div " + l(m, "loadingBox", !1, "loading") + " id='load_" + this.id + "'>" + $.jgrid.getRegional(e, "defaults.loadtext", this.p.loadtext) + "</div>").insertBefore(k),
                $(this).attr({
                    role: "presentation",
                ...
                H = function(a) {
                    var b, c, d = [],
                    f = 0;
                    for (c = 0; c < e.p.colModel.length; c++) b = e.p.colModel[c],
                    "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (d[f] = "local" === a ? b.name: "xml" === a || "xmlstring" === a ? b.xmlmap || b.name: b.jsonmap || b.name, !1 !== e.p.keyName && !0 === b.key && (e.p.keyName = d[f], e.p.keyIndex = f), f++);
                    return d
                },
                I = function(a) {
                    var b = e.p.remapColumns;
                    return b && b.length || (b = $.map(e.p.colModel,
                    function(a, b) {
                        return b
                    })),
                    a && (b = $.map(b,
                ...
                J = function(a, b) {
                    ...
                    !0 === b && this.p.treeGrid && !this.p.loadonce && (this.p.data = [], this.p._index = {})
                },
                K = function() {
                    ...
                    if ("local" === m.datatype && !0 === p.repeatitems) for (j = I(s), k = H("local"), d = !1 === m.keyName ? $.isFunction(p.id) ? p.id.call(e, n) : p.id: m.keyName, a = 0; a < o; a++) {
                        for (c = n[a], f = $.jgrid.getAccessor(c, d), void 0 === f && ("number" == typeof d && null != q[d + s] && (f = $.jgrid.getAccessor(c, q[d + s].name)), void 0 === f && (f = t + a, r && (g = $.jgrid.getAccessor(c, r) || c, f = null != g && void 0 !== g[d] ? g[d] : f, g = null))), i = {},
                ...
                L = function() {
                    ...
                    for (a = !1 === e.p.keyName || !0 === e.p.loadonce ? e.p.localReader.id: e.p.keyName, e.p._index = [], b = 0; b < d; b++) c = $.jgrid.getAccessor(e.p.data[b], a),
                ...
                P = function(a, b, c, d) {
                    ...
                    if (g && (e.p.data = [], e.p._index = {},
                    e.p.localReader.id = h), e.p.reccount = 0, $.isXMLDoc(a)) { - 1 !== e.p.treeANode || e.p.scroll ? b = b > 1 ? b: 1 : (J.call(e, !1, !0), b = 1);
                        ...
                        C = {},
                        D = [],
                        K = l(m, "rowBox", !0, "jqgrow ui-row-" + e.p.direction); ! 0 === e.p.subGrid && (y = 1, p = $.jgrid.getMethod("addSubGridCell")),
                        i.repeatitems || (B = H(j)),
                        q = !1 === e.p.keyName ? $.isFunction(i.id) ? i.id.call(e, a) : i.id: e.p.keyName,
                        i.repeatitems && e.p.keyName && isNaN(q) && (q = e.p.keyIndex),
                        r = -1 === String(q).indexOf("[") ? B.length ?
                        function(a, b) {
                            return $(q, a).text() || b
                        }: function(a, b) {
                        ...
                        if (e.p.grouping && (U = !0 === e.p.groupingView.groupCollapse, N = $.jgrid.getMethod("groupingPrepare")), O > 0 && e.p.page <= 0 && (e.p.page = 1), L && O) {
                            ...
                            for (var V = $.isFunction(e.p.afterInsertRow), W = z ? l(m, "rownumBox", !1, "jqgrid-rownum") : "", X = x ? l(m, "multiBox", !1, "cbox") : ""; P < O;) {
                                ...
                                } else for (k = 0; k < B.length; k++) o = $.jgrid.getXmlData(t, B[k]),
                ...
                Q = function(a, b, c, d) {
                    var f = new Date;
                    if (a) { - 1 !== e.p.treeANode || e.p.scroll ? b = b > 1 ? b: 1 : (J.call(e, !1, !0), b = 1);
                        var g, h, i, j, k, n, p, q, r, s, t, u, v, w, x, y = "_id_",
                        ...
                        for (z && (e.p.data = [], e.p._index = {},
                        e.p.localReader.id = y), e.p.reccount = 0, "local" === e.p.datatype ? (g = e.p.localReader, h = "local") : (g = e.p.jsonReader, h = "json"), e.p.page = A($.jgrid.getAccessor(a, g.page), e.p.page), e.p.lastpage = A($.jgrid.getAccessor(a, g.total), 1), e.p.records = A($.jgrid.getAccessor(a, g.records)), e.p.userData = $.jgrid.getAccessor(a, g.userdata) || {},
                        L && (p = $.jgrid.getMethod("addSubGridCell")), u = !1 === e.p.keyName ? $.isFunction(g.id) ? g.id.call(e, a) : g.id: e.p.keyName, g.repeatitems && e.p.keyName && isNaN(u) && (u = e.p.keyIndex), t = $.jgrid.getAccessor(a, g.root), null == t && $.isArray(a) && (t = a), t || (t = []), s = t.length, j = 0, s > 0 && e.p.page <= 0 && (e.p.page = 1), d && (P *= d + 1), "local" !== e.p.datatype || e.p.deselectAfterSort || (Q = !0), e.p.grouping && (Y = !0 === e.p.groupingView.groupCollapse, x = $.jgrid.getMethod("groupingPrepare")); j < s;) {
                            ...
                            w = e.p.idPrefix + w,
                            Q && (q = e.p.multiselect ? -1 !== $.inArray(w, e.p.selarrrow) : w === e.p.selrow);
                            var ca = U.length;
                            for (U.push(""), N && U.push(G(0, j, e.p.page, e.p.rowNum, _)), K && U.push(F(w, N, j, q, aa)), L && U.push(p.call(B, K + N, j + b)), r = S, g.repeatitems && (g.cell && (n = $.jgrid.getAccessor(n, g.cell) || n), $.isArray(n) && (r = R)), k = 0; k < r.length; k++) i = $.jgrid.getAccessor(n, r[k]),
                            T[e.p.colModel[k + K + L + N].name] = i,
                            U.push(E(w, i, k + K + L + N, j + b, n, T));
                            if (U[ca] = M(w, Y, q ? V + " " + o: V, T, n), U.push("</tr>"), e.p.grouping && (X.push(U), e.p.groupingView._locgr || x.call(B, T, j), U = []), (z || !0 === e.p.treeGrid && !e.p._ald) && (T[y] = $.jgrid.stripPref(e.p.idPrefix, w), e.p.data.push(T), e.p._index[T[y]] = e.p.data.length - 1), !1 === e.p.gridview && (Z.append(U.join("")), B.triggerHandler("jqGridAfterInsertRow", [w, T, n]), W && e.p.afterInsertRow.call(e, w, T, n), U = []), T = {},
                            C++, j++, C === P) break
                        }
                ...
                R = function(a) {
                    ...
                    if ($.isArray(e.p.data)) {
                        ...
                        if (e.p.ignoreCase && (s = s.ignoreCase()), !0 === e.p.search) {
                            ...
                            if (t)"string" == typeof t && (t = $.jgrid.parse(t)),
                            b(t);
                            else try {
                ...
                X = function(a) {
                    if (!e.grid.hDiv.loading) {
                        ...
                        case "script":
                            ...
                            break;
                        case "xmlstring":
                            if (T(), c = "string" != typeof e.p.datastr ? e.p.datastr: $.parseXML(e.p.datastr), !V(c, 200, null)) return void U();
                            P(c),
                            W(c, h);
                            break;
                        case "jsonstring":
                            if (T(), c = "string" == typeof e.p.datastr ? $.jgrid.parse(e.p.datastr) : e.p.datastr, !V(c, 200, null)) return void U();
                            Q(c),
                            W(c, h);
                            break;
                        case "local":
                ...
                Z = function(a, b) {
                    ...
                    if (a = a.substr(1), b += "_" + a, c = "pg_" + a, d = a + "_left", f = a + "_center", g = a + "_right", $("#" + $.jgrid.jqID(a)).append("<div id='" + c + "' class='ui-pager-control' role='group'><table " + l(m, "pagerTable", !1, "ui-pg-table ui-common-table ui-pager-table") + "><tbody><tr><td id='" + d + "' align='left'></td><td id='" + f + "' align='center' style='white-space:pre;'></td><td id='" + g + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr"), e.p.rowList.length > 0) {
                        t = '<td dir="' + i + '">',
                        t += "<select " + l(m, "pgSelectBox", !1, "ui-pg-selbox") + ' size="1" role="listbox" title="' + ($.jgrid.getRegional(e, "defaults.pgrecs", e.p.pgrecs) || "") + '">';
                        var v;
                        for (k = 0; k < e.p.rowList.length; k++) v = e.p.rowList[k].toString().split(":"),
                        1 === v.length && (v[1] = v[0]),
                        t += '<option role="option" value="' + v[0] + '"' + (A(e.p.rowNum, 0) === A(v[0], 0) ? ' selected="selected"': "") + ">" + v[1] + "</option>";
                        t += "</select></td>"
                    }
                    if ("rtl" === i && (s += t), !0 === e.p.pginput && (q = "<td id='input" + b + "' dir='" + i + "'>" + $.jgrid.template($.jgrid.getRegional(e, "defaults.pgtext", e.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), !0 === e.p.pgbuttons) {
                        ...
                        s += "<td id='" + w[0] + "' class='" + x + "' title='" + y[0] + "'><span " + l(m, "icon_first", !1, r) + "></span></td>",
                        s += "<td id='" + w[1] + "' class='" + x + "'  title='" + y[1] + "'><span " + l(m, "icon_prev", !1, r) + "></span></td>",
                        s += "" !== q ? o + q + o: "",
                        s += "<td id='" + w[2] + "' class='" + x + "' title='" + y[2] + "'><span " + l(m, "icon_next", !1, r) + "></span></td>",
                        s += "<td id='" + w[3] + "' class='" + x + "' title='" + y[3] + "'><span " + l(m, "icon_end", !1, r) + "></span></td>"
                    } else "" !== q && (s += q);
                    "ltr" === i && (s += t),
                    s += "</tr></tbody></table>",
                    ...
                    $("#gbox_" + $.jgrid.jqID(e.p.id)).append("<div id='testpg' " + l(m, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"),
                    h = $(s).clone().appendTo("#testpg").width(),
                    $("#testpg").remove(),
                    h > 0 && ("" !== q && (h += 50), $("td#" + a + "_" + e.p.pagerpos, "#" + c).width(h)),
                    e.p._nvtd = [],
                    e.p._nvtd[0] = h ? Math.floor((e.p.width - h) / 2) : Math.floor(e.p.width / 3),
                    e.p._nvtd[1] = 0,
                    s = null,
                    $(".ui-pg-selbox", "#" + c).on("change",
                    function() {
                    ...
                    function() {
                        ...
                        !!u(this.id.split("_")[0], this) && (this.id === "first" + b && f && (e.p.page = 1, d = !0), this.id === "prev" + b && g && (e.p.page = a - 1, d = !0), this.id === "next" + b && h && (e.p.page = a + 1, d = !0), this.id === "last" + b && i && (e.p.page = c, d = !0), d && X(), !1)
                    })),
                    !0 === e.p.pginput && $("#" + c).on("keypress", "input.ui-pg-input",
                    function(a) {
                ...
                _ = function(a, b, c) {
                    ...
                    void 0 === c ? f[a].lso ? "asc" === f[a].lso ? (f[a].lso += "-desc", h = "desc") : "desc" === f[a].lso ? (f[a].lso += "-asc", h = "asc") : "asc-desc" !== f[a].lso && "desc-asc" !== f[a].lso || (f[a].lso = "") : f[a].lso = h = f[a].firstsortorder || "asc": f[a].lso = h = c,
                    h ? ($("span.s-ico", g).show(), $("span.ui-icon-" + h, g).removeClass(n), $(g).attr("aria-selected", "true")) : e.p.viewsortcols[0] || $("span.s-ico", g).hide();
                    var i = u.indexOf(d); - 1 === i ? (u.push(d), v.push(h)) : h ? v[i] = h: (v.splice(i, 1), u.splice(i, 1)),
                    e.p.sortorder = "",
                    e.p.sortname = "";
                    for (var j = 0,
                    k = u.length; j < k; j++) j > 0 && (e.p.sortname += ", "),
                    e.p.sortname += u[j],
                ...
                aa = function(a, b, c, d, f) {
                    if (e.p.colModel[b].sortable && !(e.p.savedRow.length > 0)) {
                        if (c || (e.p.lastsort === b && "" !== e.p.sortname ? "asc" === e.p.sortorder ? e.p.sortorder = "desc": "desc" === e.p.sortorder && (e.p.sortorder = "asc") : e.p.sortorder = e.p.colModel[b].firstsortorder || "asc", e.p.page = 1), e.p.multiSort) _(b, f, d);
                            ...
                            e.p.frozenColumns && (g = e.grid.fhDiv.find("span.ui-grid-ico-sort"), g.addClass(n), j && g.css("display", "none"), e.grid.fhDiv.find("th").attr("aria-selected", "false")),
                            g = $(i).find("span.ui-icon-" + e.p.sortorder),
                            g.removeClass(n),
                            j && g.css("display", ""),
                            $(i).attr("aria-selected", "true"),
                            e.p.viewsortcols[0] || (e.p.lastsort !== b ? (e.p.frozenColumns && e.grid.fhDiv.find("span.s-ico").hide(), $("span.s-ico", h).hide(), $("span.s-ico", i).show()) : "" === e.p.sortname && $("span.s-ico", i).show()),
                ...
                ba = function() {
                    ...
                    function() {
                        ...
                        !1 === this.hidden && (g += b + h, this.fixed ? l += b + h: i++)
                    }),
                    isNaN(e.p.width) && (e.p.width = g + (!1 !== e.p.shrinkToFit || isNaN(e.p.height) ? 0 : j)),
                    f.width = parseInt(e.p.width, 10),
                    e.p.tblwidth = g,
                    !1 === e.p.shrinkToFit && !0 === e.p.forceFit && (e.p.forceFit = !1),
                    !0 === e.p.shrinkToFit && i > 0 && (c = f.width - h * i - l, isNaN(e.p.height) || (c -= j, k = !0), g = 0, $.each(e.p.colModel,
                    function(d) { ! 1 !== this.hidden || this.fixed || (b = Math.round(c * this.width / (e.p.tblwidth - h * i - l)), this.width = b, g += b, a = d)
                ...
                ga = function(a, b, c, d) {
                    ...
                    if (k) {
                        ...
                        f && !$.isEmptyObject(f) && (l = f.oper1, m = f.value1, n = f.rule, o = f.oper2, q = f.value2),
                        k.searchoptions || (k.searchoptions = {}),
                        g = k.searchoptions.sopt ? k.searchoptions.sopt: "text" === k.sorttype ? u: t,
                        h = k.searchoptions.groupOps ? k.searchoptions.groupOps: v.groupOps,
                        j = $("<form></form>");
                        var x = "<div>" + $.jgrid.getRegional(e, "colmenu.searchTitle") + "</div>";
                        x += '<div><select size="1" id="oper1" class="' + s.filter_select + '">',
                        $.each(v.odata,
                        function(a, b) {
                        ...
                        A = $.jgrid.createEl.call(e, k.stype, z, y, !1, $.extend({},
                        $.jgrid.ajaxOptions, e.p.ajaxSelectOptions || {}));
                        $(A).addClass(s.filter_input),
                        x = $("<div></div>").append(A),
                        j.append(x),
                        x = '<div><select size="1" id="operand" class="' + s.filter_select + '">',
                        $.each(h,
                        function(a, b) {
                        ...
                        x = '<div><select size="1" id="oper2" class="' + s.filter_select + '">' + r + "</select></div>",
                        j.append(x),
                        y = q || "",
                ...
                ia = function(a, b) {
                    ...
                    d = e.p.groupingView; - 1 !== b ? d.groupField.splice(b, 1) : d.groupField.push(c.name),
                    $(e).jqGrid("groupingGroupBy", d.groupField),
                    e.p.frozenColumns && ($(e).jqGrid("destroyFrozenColumns"), $(e).jqGrid("setFrozenColumns"))
                },
                ja = function(a, b) {
                    var c, d = [],
                ...
                ka = function(a, b, c) {
                    b = parseInt(b, 10),
                    c = parseInt(c, 10) + 10;
                    var d, f, g = '<ul id="column_menu" role="menu" tabindex="0">',
                    h = "",
                    i = "</ul>",
                    j = "",
                    k = e.p.colModel[a],
                    ...
                    q = $.trim(k.name);
                    o.push(h),
                    l.sorting && (h = '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="sortasc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_sort_asc + '"></span></td><td class="menu_text">' + m.sortasc + "</td></tr></table></a></li>", h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="sortdesc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_sort_desc + '"></span></td><td class="menu_text">' + m.sortdesc + "</td></tr></table></a></li>", o.push(h)),
                    l.columns && (h = '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="columns"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_columns + '"></span></td><td class="menu_text">' + m.columns + "</td></tr></table></a></li>", o.push(h)),
                    l.filtering && (h = '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="filtering"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_filter + '"></span></td><td class="menu_text">' + m.filter + " " + n + "</td></tr></table></a></li>", o.push(h)),
                    l.grouping && (d = $.inArray(k.name, e.p.groupingView.groupField), h = '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="grouping"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_group + '"></span></td><td class="menu_text">' + ( - 1 !== d ? m.ungrouping: m.grouping + " " + n) + "</td></tr></table></a></li>", o.push(h)),
                    l.freeze && (f = !k.frozen || !e.p.frozenColumns, h = '<li class="ui-menu-item divider" role="separator"></li>', h += '<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="freeze"><table class="ui-common-table"><tr><td class="menu_icon"><span class="' + r + " " + s.icon_freeze + '"></span></td><td class="menu_text">' + (f ? m.freeze + " " + n: m.unfreeze) + "</td></tr></table></a></li>", o.push(h));
                    for (var t in e.p.colMenuCustom) if (e.p.colMenuCustom.hasOwnProperty(t)) {
                    ...
                    $("#column_menu > li > a").hover(function() {
                        ...
                        $("#search_menu").remove();
                        var b, c;
                        "columns" === $(this).attr("data-value") && (b = $(this).parent().width() + 8, c = $(this).parent().position().top - 5, fa(c, b, $(this).parent())),
                        "filtering" === $(this).attr("data-value") && (b = $(this).parent().width() + 8, c = $(this).parent().position().top - 5, ga(a, c, b, $(this).parent())),
                        $(this).addClass(p)
                    },
                    function() {
                        $(this).removeClass(p)
                ...
                for ((e.p.colMenu || e.p.menubar) && $("body").on("click",
                function(a) {
                ...
                }), this.p.id = this.id, -1 === $.inArray(e.p.multikey, z) && (e.p.multikey = !1), e.p.keyName = !1, j = 0; j < e.p.colModel.length; j++) y = "string" == typeof e.p.colModel[j].template ? null != $.jgrid.cmTemplate && "object" == typeof $.jgrid.cmTemplate[e.p.colModel[j].template] ? $.jgrid.cmTemplate[e.p.colModel[j].template] : {}: e.p.colModel[j].template,
                e.p.colModel[j] = $.extend(!0, {},
                e.p.cmTemplate, y || {},
                e.p.colModel[j]),
                !1 === e.p.keyName && !0 === e.p.colModel[j].key && (e.p.keyName = e.p.colModel[j].name, e.p.keyIndex = j);
                ...
                e.p.localReader),
                e.p.scroll && (e.p.pgbuttons = !1, e.p.pginput = !1, e.p.rowList = []),
                e.p.data.length && (K(), L());
                var la, ma, na, oa, pa, qa, ra, sa, ta, ua = "<thead><tr class='ui-jqgrid-labels' role='row'>",
                va = "",
                wa = "",
                xa = "";
                ...
                for (j = 0; j < this.p.colNames.length; j++) {
                    ...
                    ta = e.p.colModel[j],
                    ta.hasOwnProperty("colmenu") || (ta.colmenu = "rn" !== ta.name && "cb" !== ta.name && "subgrid" !== ta.name),
                    ua += "<th id='" + e.p.id + "_" + ta.name + "' role='columnheader' " + l(m, "headerBox", !1, "ui-th-column ui-th-" + i) + " " + ya + ">",
                    ma = ta.index || ta.name,
                    ua += "<div class='ui-th-div' id='jqgh_" + e.p.id + "_" + ta.name + "' " + la + ">" + e.p.colNames[j],
                    ...
                    ua += sa,
                    e.p.colMenu && ta.colmenu && (ua += "<a class='" + ("ltr" === e.p.direction ? "colmenu": "colmenu-rtl") + "'><span class='colmenuspan " + r + " " + s.icon_menu + "'></span></a>"),
                    ua += "</div></th>"
                }
                ...
                function() {
                    ...
                    var za, Aa = [];
                    $("#cb_" + $.jgrid.jqID(e.p.id), this).on("click",
                    function() {
                        e.p.selarrrow = [];
                        ...
                        }), e.p.selrow = null, za = !1),
                        $(e).triggerHandler("jqGridSelectAll", [za ? e.p.selarrrow: Aa, za]),
                        $.isFunction(e.p.onSelectAll) && e.p.onSelectAll.call(e, za ? e.p.selarrrow: Aa, za)
                    })
                }
                if (!0 === e.p.autowidth) {
                    var Ba = $(x).parent().width();
                    ta = $(window).width(),
                    e.p.width = ta - Ba > 3 ? Ba: ta
                }
                var Ca = "",
                Da = -1 !== e.p.styleUI.search("Bootstrap") ? 2 : 0;
                ba(),
                $(x).css("width", f.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + e.p.id + "'>&#160;</div>"),
                e.p.scrollPopUp && $(x).append("<div " + l(m, "scrollBox", !1, "loading ui-scroll-popup") + " id='scroll_g" + e.p.id + "'></div>"),
                $(k).css("width", f.width + "px"),
                ua = $("thead:first", e).get(0),
                e.p.footerrow && (Ca += "<table role='presentation' style='width:" + e.p.tblwidth + "px' " + l(m, "footerTable", !1, "ui-jqgrid-ftable ui-common-table") + "><tbody><tr role='row' " + l(m, "footerBox", !1, "footrow footrow-" + i) + ">");
                var Ea = $("tr:first", ua),
                ...
                if (e.p.disableClick = !1, $("th", Ea).each(function(a) {
                    ...
                    ta.resizable ? (oa = document.createElement("span"), $(oa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + i).css("cursor", "col-resize"), $(this).addClass(e.p.resizeclass)) : oa = "",
                    $(this).css("width", na + "px").prepend(oa),
                    oa = null;
                    var b = "";
                    ta.hidden && ($(this).css("display", "none"), b = "display:none;"),
                    Fa += "<td role='gridcell' style='height:0px;width:" + na + "px;" + b + "'></td>",
                    f.headers[a] = {
                        width: na,
                        el: this
                    },
                    ...
                    va && (e.p.multiSort ? e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), ta.lso && $("div span.ui-icon-" + ta.lso, this).removeClass(n).css("display", "")) : ta.lso && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + ta.lso, this).removeClass(n).css("display", "")) : e.p.viewsortcols[0] ? ($("div span.s-ico", this).show(), a === e.p.lastsort && $("div span.ui-icon-" + e.p.sortorder, this).removeClass(n).css("display", "")) : a === e.p.lastsort && "" !== e.p.sortname && ($("div span.s-ico", this).show(), $("div span.ui-icon-" + e.p.sortorder, this).removeClass(n).css("display", ""))),
                    e.p.footerrow && (Ca += "<td role='gridcell' " + B(a, 0, "", null, "", !1) + ">&#160;</td>")
                }).mousedown(function(a) {
                    if (1 === $(a.target).closest("th>span.ui-jqgrid-resize").length) {
                        var b = ea(this);
                        return ! 0 === e.p.forceFit && (e.p.nv = ca(b)),
                        f.dragStart(b, a, da(b)),
                        !1
                    }
                }).click(function(a) {
                    if (e.p.disableClick) return e.p.disableClick = !1,
                    !1;
                    ...
                    if (1 === f.length) {
                        ...
                        return e.p.viewsortcols[2] || (b = !0, c = f.attr("sort")),
                ...
                this.appendChild(ra),
                $(this).addClass(l(m, "rowTable", !0, "ui-jqgrid-btable ui-common-table")).append(Fa),
                ...
                Ga = null,
                Ha && $(f.hDiv).hide(),
                e.p.pager && ("string" == typeof e.p.pager ? "#" !== e.p.pager.substr(0, 1) && (e.p.pager = "#" + e.p.pager) : e.p.pager = "#" + $(e.p.pager).attr("id"), $(e.p.pager).css({
                    width: f.width - Da + "px"
                }).addClass(l(m, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(x), Ha && $(e.p.pager).hide(), Z(e.p.pager, "")),
                ...
                $(e).before(f.hDiv).on({
                    click: function(a) {
                        ...
                        if (d = !1 !== d && "stop" !== d, $.isFunction(e.p.beforeSelectRow)) {
                            var f = e.p.beforeSelectRow.call(e, qa[0].id, a); ! 1 !== f && "stop" !== f || (d = !1)
                        }
                        if ("A" !== pa.tagName && ("INPUT" !== pa.tagName && "TEXTAREA" !== pa.tagName && "OPTION" !== pa.tagName && "SELECT" !== pa.tagName || c)) if (Ja = qa[0].id, pa = $(pa).closest("tr.jqgrow>td"), pa.length > 0 && (Ka = $.jgrid.getCellIndex(pa)), !0 !== e.p.cellEdit) {
                            if (pa.length > 0 && (La = $(pa).closest("td,th").html(), $(e).triggerHandler("jqGridCellSelect", [Ja, Ka, La, a]), $.isFunction(e.p.onCellSelect) && e.p.onCellSelect.call(e, Ja, Ka, La, a)), d) if (e.p.multimail && e.p.multiselect) {
                                if (a.shiftKey) {
                                    if (c) {
                                ...
                                b(Ja, c, a, !1)
                            } else e.p.multikey ? a[e.p.multikey] ? $(e).jqGrid("setSelection", Ja, !0, a) : e.p.multiselect && c && (c = $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Ja).is(":checked"), $("#jqg_" + $.jgrid.jqID(e.p.id) + "_" + Ja)[e.p.useProp ? "prop": "attr"]("checked", !c)) : b(Ja, c, a, !0)
                    ...
                    reloadGrid: function(a, b) {
                        if (!0 === e.p.treeGrid && (e.p.datatype = e.p.treedatatype), b = b || {},
                        b.current && e.grid.selectionPreserver(e), "local" === e.p.datatype ? ($(e).jqGrid("resetSelection"), e.p.data.length && (K(), L())) : e.p.treeGrid || (e.p.selrow = null, e.p.multiselect && (e.p.selarrrow = [], Y(!1)), e.p.savedRow = []), e.p.scroll && J.call(e, !0, !1), b.page) {
                            var c = b.page;
                        ...
                        return e.grid.prevRowHeight && e.p.scroll && void 0 === b.page ? (delete e.p.lastpage, e.grid.populateVisible()) : e.grid.populate(),
                    ...
                    dblclick: function(a) {
                        if (pa = a.target, qa = $(pa, e.rows).closest("tr.jqgrow"), 0 !== $(qa).length) {
                            ...
                            return null != b ? b: $.isFunction(e.p.ondblClickRow) && null != (b = e.p.ondblClickRow.call(e, $(qa).attr("id"), Ja, Ka, a)) ? b: void 0
                        }
                    },
                    contextmenu: function(a) {
                        if (pa = a.target, qa = $(pa, e.rows).closest("tr.jqgrow"), 0 !== $(qa).length) {
                            e.p.multiselect || $(e).jqGrid("setSelection", qa[0].id, !0, a),
                            Ja = qa[0].rowIndex,
                            Ka = $.jgrid.getCellIndex(pa);
                            var b = $(e).triggerHandler("jqGridRightClickRow", [$(qa).attr("id"), Ja, Ka, a]);
                            return null != b ? b: $.isFunction(e.p.onRightClickRow) && null != (b = e.p.onRightClickRow.call(e, $(qa).attr("id"), Ja, Ka, a)) ? b: void 0
                        }
                    }
                }),
                f.bDiv = document.createElement("div"),
                t && "auto" === String(e.p.height).toLowerCase() && (e.p.height = "100%"),
                ...
                e.p.multikey && ($.jgrid.msie() ? $(f.bDiv).on("selectstart",
                function() {
                    return ! 1
                }) : $(f.bDiv).on("mousedown",
                function() {
                ...
                if ($(f.cDiv).append(Oa).append("<span class='ui-jqgrid-title'>" + e.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === i ? "-rtl": "") + " " + l(m, "gridtitleBox", !0)), !0 === e.p.menubar) {
                    ...
                    $(f.cDiv).append("<a role='link' class='ui-jqgrid-menubar menubar-" + ("rtl" === i ? "rtl": "ltr") + "' style=''><span class='colmenuspan " + r + " " + s.icon_toolbar_menu + "'></span></a>"),
                ...
                if (e.p.toppager && (e.p.toppager = $.jgrid.jqID(e.p.id) + "_toppager", f.topDiv = $("<div id='" + e.p.toppager + "'></div>")[0], e.p.toppager = "#" + e.p.toppager, $(f.topDiv).addClass(l(m, "toppagerBox", !0, "ui-jqgrid-toppager")).width(f.width - Da).insertBefore(f.hDiv), Z(e.p.toppager, "_t")), e.p.footerrow && (f.sDiv = $("<div class='ui-jqgrid-sdiv'></div>")[0], Ia = $("<div class='ui-jqgrid-hbox" + ("rtl" === i ? "-rtl": "") + "'></div>"), $(f.sDiv).append(Ia).width(f.width - Da).insertAfter(f.hDiv), $(Ia).append(Ca), f.footers = $(".ui-jqgrid-ftable", f.sDiv)[0].rows[0].cells, e.p.rownumbers && (f.footers[0].className = l(m, "rownumBox", !0, "jqgrid-rownum")), Ha && $(f.sDiv).hide()), Ia = null, e.p.caption) {
                    var Ra = e.p.datatype; ! 0 === e.p.hidegrid && ($(".ui-jqgrid-titlebar-close", f.cDiv).click(function(a) {
                        var b, c = $.isFunction(e.p.onHeaderClick),
                        d = ".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-toppager, .ui-jqgrid-pager, .ui-jqgrid-sdiv",
                        g = this;
                        return ! 0 === e.p.toolbar[0] && ("both" === e.p.toolbar[1] && (d += ", #" + $(f.ubDiv).attr("id")), d += ", #" + $(f.uDiv).attr("id")),
                        b = $(d, "#gview_" + $.jgrid.jqID(e.p.id)).length,
                        "visible" === e.p.gridstate ? $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideUp("fast",
                        function() {
                        ...
                        }) : "hidden" === e.p.gridstate && $(d, "#gbox_" + $.jgrid.jqID(e.p.id)).slideDown("fast",
                        function() {
                ...
                e.p.toppager || $(f.hDiv).addClass(l(e.p.styleUI + ".common", "cornertop", !0));
                if ($(f.hDiv).after(f.bDiv).mousemove(function(a) {
                    if (f.resizing) return f.dragMove(a),
                    !1
                }), $(".ui-jqgrid-labels", f.hDiv).on("selectstart",
                function() {
                    return ! 1
                }), $(document).on("mouseup.jqGrid" + e.p.id,
                function() {
                    return ! f.resizing || (f.dragEnd(!0), !1)
                }), "rtl" === e.p.direction && $(e).on("jqGridAfterGridComplete.setRTLPadding",
                function() {
                    var a = f.bDiv.offsetWidth - f.bDiv.clientWidth;
                    e.p.scrollOffset = a,
                    $("div:first", f.hDiv).css({
                        paddingLeft: a + "px"
                    }),
                    f.hDiv.scrollLeft = f.bDiv.scrollLeft
    ...
    $.jgrid.extend({
        ...
        getDataIDs: function() {
            ...
            d = 0;
            return this.each(function() {
                if ((a = this.rows.length) && a > 0) for (; c < a;) $(this.rows[c]).hasClass("jqgrow") && (b[d] = this.rows[c].id, d++),
                c++
            }),
            b
        },
        ...
        getRowData: function(a, b) {
            ...
            return this.each(function() {
                ...
                for (b && !0 === b && j.p.data.length > 0 || (b = !1); g < d;) f && (i = j.rows[g + 1]),
        ...
        addRowData: function(a, b, c, d) { - 1 === $.inArray(c, ["first", "last", "before", "after"]) && (c = "last");
            ...
            return b && ($.isArray(b) ? (m = !0, n = a) : (b = [b], m = !1), this.each(function() {
                ...
                h = !0 === v.p.subGrid ? 1 : 0,
                m || (void 0 !== a ? a = String(a) : (a = $.jgrid.randId(), !1 !== v.p.keyName && (n = v.p.keyName, void 0 !== b[0][n] && (a = b[0][n]))));
                var x = 0,
                ...
                for (i && (s = $(v).jqGrid("getStyleUI", v.p.styleUI + ".base", "rownumBox", !1, "jqgrid-rownum")), g && (t = $(v).jqGrid("getStyleUI", v.p.styleUI + ".base", "multiBox", !1, "cbox")); x < w;) {
                    ...
                    case "after":
                        ...
                        j && ($(v.rows[j.rowIndex + 1]).hasClass("ui-subgrid") ? $(v.rows[j.rowIndex + 1]).after(f) : $(j).after(f.join("")), j = j.rowIndex + 1);
                        break;
                    case "before":
                        j = $(v).jqGrid("getGridRowById", d),
                    ...
                    x++,
                    "local" === v.p.datatype && (z[v.p.localReader.id] = q, v.p._index[q] = v.p.data.length, v.p.data.push(z), z = {})
                }
                v.updatepager(!0, !0),
                r = !0
            })),
                ...
                if (this.grid) {
                    ...
                    if ("boolean" != typeof b && (b = g.p.shrinkToFit), !isNaN(a)) {
                        if (a = parseInt(a, 10), g.grid.width = g.p.width = a, $("#gbox_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $("#gview_" + $.jgrid.jqID(g.p.id)).css("width", a + "px"), $(g.grid.bDiv).css("width", a - n + "px"), $(g.grid.hDiv).css("width", a - n + "px"), g.p.pager && $(g.p.pager).css("width", a - n + "px"), g.p.toppager && $(g.p.toppager).css("width", a - n + "px"), !0 === g.p.toolbar[0] && ($(g.grid.uDiv).css("width", a - n + "px"), "both" === g.p.toolbar[1] && $(g.grid.ubDiv).css("width", a - n + "px")), g.p.footerrow && $(g.grid.sDiv).css("width", a - n + "px"), !1 === b && !0 === g.p.forceFit && (g.p.forceFit = !1), !0 === b) {
                            ...
                            function() { ! 1 === this.hidden && (c = this.widthOrg, h += c + i, this.fixed ? m += c + i: j++)
                            }), 0 === j) return;
                            g.p.tblwidth = h,
                            e = a - i * j - m,
                    ...
                    if (k) {
                        ...
                        if (l) {
                            if ("" !== c || !0 === f) {
                                ...
                                else if (void 0 !== k.cells) for (; m < k.cells.length;) g = $.unformat.call(i, $(k.cells[m]), {
                                    rowId: k.id,
        ...
        getCell: function(a, b, c) {
            ...
            this.each(function() {
                ...
                if (h.grid && (f = b, isNaN(b) ? $(h.p.colModel).each(function(a) {
                    if (this.name === b) return f = this.name,
                    i = a,
                    !1
                }) : i = parseInt(b, 10), i >= 0 && (g = $(h).jqGrid("getGridRowById", a)))) if (d = $("td:eq(" + i + ")", g), c) e = d;
                else {
                    try {
                        e = $.unformat.call(h, d, {
                            rowId: g.id,
        ...
        getCol: function(a, b, c) {
            var d, e, f, g, h = [],
            i = 0;
            return b = "boolean" == typeof b && b,
            void 0 === c && (c = !1),
            this.each(function() {
                var j = this,
                k = -1;
                if (j.grid && (isNaN(a) ? $(j.p.colModel).each(function(b) {
                    if (this.name === a) return k = b,
                    !1
                }) : k = parseInt(a, 10), k >= 0)) {
                    var l = j.rows.length,
                    m = 0,
        ...
        getInd: function(a, b) {
            var c, d = !1;
            return this.each(function() { (c = $(this).jqGrid("getGridRowById", a)) && (d = !0 === b ? c: c.rowIndex)
            }),
            d
        },
        bindKeys: function(a) {
                ...
                $(a).keydown(function(c) {
                    ...
                    if (g) {
                        ...
                        if (f = a.p._index[$.jgrid.stripPref(a.p.idPrefix, g.id)], 37 === c.keyCode || 38 === c.keyCode || 39 === c.keyCode || 40 === c.keyCode) {
                            ...
                            37 === c.keyCode && (a.p.treeGrid && a.p.data[f][h] && $(g).find("div.treeclick").trigger("click"), $(a).triggerHandler("jqGridKeyLeft", [a.p.selrow, c]), $.isFunction(b.onLeftKey) && b.onLeftKey.call(a, a.p.selrow, c)),
                            39 === c.keyCode && (a.p.treeGrid && !a.p.data[f][h] && $(g).find("div.treeclick").trigger("click"), $(a).triggerHandler("jqGridKeyRight", [a.p.selrow, c]), $.isFunction(b.onRightKey) && b.onRightKey.call(a, a.p.selrow, c))
                        ...
                        if (e >= 0 && f) {
                            ...
                            if (a.p.groupHeader) {
                                ...
                                $("tr.jqg-second-row-header th", n).each(function() {
                                    if (o = parseInt($(this).attr("colspan"), 10), p = parseInt($(this).attr("rowspan"), 10), p && (q++, r++), o && (q += o, r++), q === e) return r = e,
                                    !1
                                }),
                                q !== e && (r = e),
                            ...
                            if ($(n).width(1), $.jgrid.msie() || $(n).css("height", "100%"), $(a.grid.fhDiv).append(n).mousemove(function(b) {
                                if (a.grid.resizing) return a.grid.dragMove(b),
                                !1
                            }), a.p.footerrow) {
                            ...
                            $(a).on("jqGridResizeStop.setFrozenColumns",
                            function(b, c, d) {
                            ...
                            $(a.grid.fbDiv).on("mousewheel DOMMouseScroll",
                            function(b) {
                            ...
                            $(a).on("jqGridAfterGridComplete.setFrozenColumns",
                            function() {
        ...
        menubarAdd: function(a) {
            ...
            return this.each(function() {
                ...
                if ($.isArray(a)) for (var f = 0; f < a.length; f++) {
                    ...
                    b.divider ? (c = '<li class="ui-menu-item divider" role="separator"></li>', b.cick = null) : c = '<li class="ui-menu-item" role="presentation"><a id="' + b.id + '" class="g-menu-item" tabindex="0" role="menuitem" ><table class="ui-common-table"><tr><td class="menu_icon">' + g + '</td><td class="menu_text">' + b.title + "</td></tr></table></a></li>",
                    "last" === b.position ? $("#" + this.p.id + "_menubar").append(c) : $("#" + this.p.id + "_menubar").prepend(c)
                }
                $("li a", "#" + this.p.id + "_menubar").each(function(b, c) {
                    $(a).each(function(a, b) {
                        if (b.id === c.id && $.isFunction(b.click)) return $(c).on("click",
                        function(a) {
                            b.click.call(d, a)
                        }),
                        !1
...
function(a) {
    ...
    a.fn.fmatter.checkbox = function(b, c) {
        ...
        b = String(b),
        b = (b + "").toLowerCase(),
        '<input type="checkbox" ' + (b.search(/(false|f|0|no|n|off|undefined)/i) < 0 ? " checked='checked' ": "") + ' value="' + b + '" offval="no" ' + d + "/>"
    },
    ...
    a.fn.fmatter.select = function(b, c) {
        ...
        if (void 0 !== c.colModel.formatoptions ? (f = c.colModel.formatoptions.value, d = void 0 === c.colModel.formatoptions.separator ? ":": c.colModel.formatoptions.separator, e = void 0 === c.colModel.formatoptions.delimiter ? ";": c.colModel.formatoptions.delimiter) : void 0 !== c.colModel.editoptions && (f = c.colModel.editoptions.value, d = void 0 === c.colModel.editoptions.separator ? ":": c.colModel.editoptions.separator, e = void 0 === c.colModel.editoptions.delimiter ? ";": c.colModel.editoptions.delimiter), f) {
            var h, i = !0 == (null != c.colModel.editoptions && !0 === c.colModel.editoptions.multiple),
            j = [];
    ...
    a.fn.fmatter.actions = function(b, c) {
        ...
        "<div style='margin-left:8px;'>" + (g += "<div title='" + h.canceltitle + "' style='float:left;display:none;' class='ui-pg-div ui-inline-cancel' " + d + "><span class='" + j.icon_base + " " + i.icon_cancel + "'></span></div>") + "</div>"
    },
...
function(a) {
    ...
    a.extend(a.jgrid, {
        ...
        hideModal: function(b, c) {
            ...
            c || {});
            var d = !(!c.gb || "string" != typeof c.gb || "#gbox_" !== c.gb.substr(0, 6)) && a("#" + c.gb.substr(6))[0];
            if (c.onClose) {
        ...
        createModal: function(b, c, d, e, f, g, h) {
            ...
            m.appendChild(p),
            a(m).prepend(n),
            !0 === g ? a("body").append(m) : "string" == typeof g ? a(g).append(m) : a(m).insertBefore(e),
            a(m).css(h),
            ...
            a("#" + a.jgrid.jqID(b.themodal)).jqResize(".jqResize", !!b.scrollelm && "#" + a.jgrid.jqID(b.scrollelm));
            else try {
                a(m).resizable({
                    handles: "se, sw",
        ...
        viewModal: function(b, c) {
            ...
            if (c.gbox) {
                ...
                try {
                    d = a(e).jqGrid("getStyleUI", e.p.styleUI + ".common", "overlay", !1, "jqgrid-overlay-modal"),
                    c.overlayClass = a(e).jqGrid("getStyleUI", e.p.styleUI + ".common", "overlay", !0)
                } catch(a) {}
            }
        ...
        info_dialog: function(b, c, d, e) {
            ...
            o += d ? "<div class='" + i.content + "' style='text-align:" + f.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a id='closedialog' class='fm-button " + j.button + "'>" + d + "</a>" + l + "</div>": "" !== l ? "<div class='" + i.content + "' style='text-align:" + f.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>" + l + "</div>": "",
            o += "</div>";
            try {
            ...
            l && a.each(f.buttons,
            function(b) {
                a("#" + a.jgrid.jqID(this.id), "#info_id").on("click",
                function() {
                    return f.buttons[b].onClick.call(a("#info_dialog")),
                    !1
                })
            }),
            a("#closedialog", "#info_id").on("click",
            function() {
        ...
        bindEv: function(b, c) {
            ...
            function() {
                void 0 !== this.data ? a(b).on(this.type, this.data, this.fn) : a(b).on(this.type, this.fn)
            })
        },
        createEl: function(b, c, d, e, f) {
            ...
            case "select":
                ...
                if (!0 === c.multiple ? (l = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : l = !1, null != c.dataUrl) {
                    ...
                    a.ajax(a.extend({
                        ...
                        success: function(b) {
                            ...
                            if ("string" == typeof m && (m = a(a.trim(m)).html()), m) {
                                if (a(e).append(m), g(e, h, o ? ["postData"] : void 0), void 0 === h.size && (h.size = j ? 3 : 1), j ? (d = f.split(","), d = a.map(d,
                                function(b) {
                                    return a.trim(b)
                                    ...
                                    var n, p = a("#fbox_" + i.p.id)[0].p.columns;
                                    a.each(p,
                                    function(a) {
                                        if (n = this.index || this.name, h.name === n) return this.searchoptions.dataUrl = null,
                    ...
                    var q, r, s, t, u, v, w = void 0 === c.separator ? ":": c.separator,
                    x = void 0 === c.delimiter ? ";": c.delimiter;
                    if ("string" == typeof c.value) for (q = c.value.split(x), p = 0; p < q.length; p++) r = q[p].split(w),
        ...
        validateForm: function(b) {
            var c, d, e = !0;
            for (c = 0; c < b.elements.length; c++) if (d = b.elements[c], ("INPUT" === d.nodeName || "TEXTAREA" === d.nodeName || "SELECT" === d.nodeName) && (void 0 !== d.willValidate ? ("INPUT" === d.nodeName && d.type !== d.getAttribute("type") && d.setCustomValidity(a.jgrid.LegacyValidation(d) ? "": "error"), d.reportValidity()) : (d.validity = d.validity || {},
            d.validity.valid = a.jgrid.LegacyValidation(d)), !d.validity.valid)) {
                e = !1;
                break
            }
            return e
        ...
        buildButtons: function(b, c, d) {
            ...
            function(b, g) {
                ...
                g.side || (g.side = "left"),
                e = g.icon ? " fm-button-icon-" + g.side + "'><span class='" + d.icon_base + " " + g.icon + "'></span>": "'>",
                f = "<a  data-index='" + b + "' id='" + g.id + "' class='fm-button " + d.button + e + g.text + "</a>",
    ...
    a.jgrid.extend({
        editGridRow: function(c, d) {
            ...
            this.each(function() {
                    ...
                    a(A).find(".FormElement").each(function() {
                        ...
                        if (c.length) {
                            ...
                            case "radio":
                                ...
                                d[this.name] = void 0 === a(this).attr("offval") ? "off": a(this).attr("offval");
                                break;
                            default:
                                u[this.name] = a(this).val()
                            }
                ...
                function f(c, d, e, f) {
                    ...
                    if ("_empty" !== c && (r = a(d).jqGrid("getInd", c)), a(d.p.colModel).each(function(n) {
                        if (h = this.name, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'": "", "cb" !== h && "subgrid" !== h && !0 === this.editable && "rn" !== h) {
                            ...
                            if ("_empty" === c && t.defaultValue && (k = a.isFunction(t.defaultValue) ? t.defaultValue.call(s) : t.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, t, k, !1, a.extend({},
                            a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select", "color", "date", "datetime", "datetime-local", "email", "month", "number", "range", "search", "tel", "time", "url", "week"]) > -1 && a(m).addClass(g.inputClass), o = !0, F) {
                                ...
                                0 === j.length && (j = a("<tr " + l + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h), a(j).append(u), a(e).append(j), j[0].rp = w),
                                a("td:eq(" + (x - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void 0 === v.label ? d.p.colNames[n] : v.label) + "</label>"),
                                a("td:eq(" + (x - 1) + ")", j[0]).append(v.elmprefix).append(m).append(v.elmsuffix)
                            } (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && o && (s.p.savedData[h] = k),
                            "custom" === this.edittype && a.isFunction(t.custom_value) && t.custom_value.call(s, a("#" + h, y), "set", k),
                        ...
                        (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (s.p.savedData[d.p.id + "_id"] = c)
                    }
                    return q
                }
                function i(c, d, e) {
                    var f, g, h, i, j, k, l = 0; (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (s.p.savedData = {},
                    ...
                    n && (a('td[role="gridcell"]', n).each(function(h) {
                        if ("cb" !== (f = m[h].name) && "subgrid" !== f && "rn" !== f && !0 === m[h].editable) {
                            ...
                            case "checkbox":
                                ...
                                g.search(/(false|f|0|no|n|off|undefined)/i) < 0 && "" !== g ? (a("#" + f, e)[s.p.useProp ? "prop": "attr"]("checked", !0), a("#" + f, e)[s.p.useProp ? "prop": "attr"]("defaultChecked", !0)) : (a("#" + f, e)[s.p.useProp ? "prop": "attr"]("checked", !1), a("#" + f, e)[s.p.useProp ? "prop": "attr"]("defaultChecked", !1)); (!0 === b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (g = a("#" + f, e).is(":checked") ? a("#" + f, e).val() : a("#" + f, e).attr("offval"), s.p.savedData[f] = g);
                                break;
                            case "custom":
                                try {
                    ...
                    if (j(), n[0] && (o = a(s).triggerHandler("jqGridAddEditClickSubmit", [b[s.p.id], u, w]), void 0 === o && a.isFunction(b[s.p.id].onclickSubmit) && (o = b[s.p.id].onclickSubmit.call(s, b[s.p.id], u, w) || {}), n = a(s).triggerHandler("jqGridAddEditBeforeSubmit", [u, a(y), w]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].beforeSubmit) && (n = b[s.p.id].beforeSubmit.call(s, u, a(y), w))), n[0] && !b[s.p.id].processing) {
                        ...
                        var v = a.extend({
                            ...
                            complete: function(g, j) {
                                var l;
                                if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [g, w]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [g, u, w]), void 0 === n && (n = [!0, "", ""]), n[0] && a.isFunction(b[s.p.id].afterSubmit) && (n = b[s.p.id].afterSubmit.call(s, g, u, w))), !1 === n[0]) a(".FormError", y).html(n[1]),
                                a(".FormError", y).show();
                                else if (s.p.autoencode && a.each(u,
                                function(b, c) {
                        ...
                        if (v.url || b[s.p.id].useDataProxy || (a.isFunction(s.p.dataProxy) ? b[s.p.id].useDataProxy = !0 : (n[0] = !1, n[1] += " " + G.nourl)), n[0]) if (b[s.p.id].useDataProxy) {
                            ...
                            void 0 === z && (z = [!0, ""]),
                            !1 === z[0] ? (n[0] = !1, n[1] = z[1] || "Error deleting the selected row!") : (v.data.oper === p.addoper && b[s.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(B.themodal), {
                                gb: "#gbox_" + a.jgrid.jqID(x),
                                jqm: d.jqModal,
                                onClose: b[s.p.id].onClose,
                                removemodal: b[s.p.id].removemodal,
                ...
                function m() {
                    var c = !0;
                    return a(".FormError", y).hide(),
                    b[s.p.id].checkOnUpdate && (u = {},
                    e(), (v = l(u, s.p.savedData)) && (a(y).data("disabled", !0), a(".confirm", "#" + B.themodal).show(), c = !1)),
                    c
                }
                function n() {
                    var b;
                    if ("_empty" !== c && void 0 !== s.p.savedRow && s.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow)) for (b = 0; b < s.p.savedRow.length; b++) if (s.p.savedRow[b].id === c) {
                ...
                function o(b, c) {
                    var d = c[1].length - 1;
                    0 === b ? a("#pData", t).addClass(h.disabled) : void 0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass(h.disabled) ? a("#pData", t).addClass(h.disabled) : a("#pData", t).removeClass(h.disabled),
                    b === d ? a("#nData", t).addClass(h.disabled) : void 0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass(h.disabled) ? a("#nData", t).addClass(h.disabled) : a("#nData", t).removeClass(h.disabled)
                }
                function p() {
                    var c, d = a(s).jqGrid("getDataIDs"),
                    e = a("#id_g", A).val();
                    if (s.p.multiselect && b[s.p.id].editselected) {
                        for (var f = [], g = 0, h = d.length; g < h; g++) - 1 !== a.inArray(d[g], s.p.selarrrow) && f.push(d[g]);
                        return c = a.inArray(e, f),
                        [c, f]
                    }
                    return c = a.inArray(e, d),
                    [c, d]
                }
                function q(a) {
                    var b = "";
                ...
                if (s.grid && c) {
                    ...
                    D = 1,
                    E = 0,
                    F = "string" == typeof b[s.p.id].template && b[s.p.id].template.length > 0,
                    G = a.jgrid.getRegional(this, "errors");
                    b[s.p.id].styleUI = s.p.styleUI || "jQueryUI",
                    a.jgrid.isMobile() && (b[s.p.id].resize = !1),
                    "new" === c ? (c = "_empty", w = "add", d.caption = b[s.p.id].addCaption) : (d.caption = b[s.p.id].editCaption, w = "edit"),
                    d.recreateForm || a(s).data("formProp") && a.extend(b[a(this)[0].p.id], a(s).data("formProp"));
                    var H = !0;
                    d.checkOnUpdate && d.jqModal && !d.modal && (H = !1);
                    var I, J = isNaN(b[a(this)[0].p.id].dataheight) ? b[a(this)[0].p.id].dataheight: b[a(this)[0].p.id].dataheight + "px",
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function() {
                        ...
                        var W = !1; ! 0 === d.closeOnEscape && (d.closeOnEscape = !1, W = !0);
                        var X;
                        F ? (a(L).find("#pData").replaceWith(P), a(L).find("#nData").replaceWith(Q), a(L).find("#sData").replaceWith(R), a(L).find("#cData").replaceWith(S), X = a("<div id=" + z + "></div>").append(L)) : X = a("<div></div>").append(L).append(U),
                        a(L).append("<div class='binfo topinfo bottominfo'>" + b[s.p.id].bottominfo + "</div>");
                        ...
                        if (a.jgrid.createModal(B, X, b[a(this)[0].p.id], "#gview_" + a.jgrid.jqID(s.p.id), a("#gbox_" + a.jgrid.jqID(s.p.id))[0], null, {
                            ...
                            if (!0 === b[s.p.id].savekey[0] && c.which === b[s.p.id].savekey[1] && "TEXTAREA" !== e.tagName) return a("#sData", A + "_2").trigger("click"),
                            !1;
                            ...
                            if (!0 === b[s.p.id].navkeys[0]) {
                                ...
                                if (c.which === b[s.p.id].navkeys[1]) return a("#pData", t).trigger("click"),
                                !1;
                                if (c.which === b[s.p.id].navkeys[2]) return a("#nData", t).trigger("click"),
                                !1
                            }
                            ...
                            R = "<a id='sNew' class='fm-button " + h.button + "' style='z-index:1002'>" + d.bYes + "</a>",
                            Q = "<a id='nNew' class='fm-button " + h.button + "' style='z-index:1002;margin-left:5px'>" + d.bNo + "</a>",
                            S = "<a id='cNew' class='fm-button " + h.button + "' style='z-index:1002;margin-left:5px;'>" + d.bExit + "</a>";
                            var Z = d.zIndex || 999;
                            Z++,
                            a("#" + B.themodal).append("<div class='" + d.overlayClass + " jqgrid-overlay confirm' style='z-index:" + Z + ";display:none;position:absolute;'>&#160;</div><div class='confirm ui-jqconfirm " + h.content + "' style='z-index:" + (Z + 1) + "'>" + d.saveData + "<br/><br/>" + R + Q + S + "</div>"),
                            ...
                            a("#nNew", "#" + a.jgrid.jqID(B.themodal)).click(function() {
                                return a(".confirm", "#" + a.jgrid.jqID(B.themodal)).hide(),
                                a(y).data("disabled", !1),
                                setTimeout(function() {
                                    a(":input:visible", y)[0].focus()
                                },
                        ...
                        a.isFunction(b[s.p.id].onInitializeForm) && b[s.p.id].onInitializeForm.call(s, a(y), w),
                        "_empty" !== c && b[s.p.id].viewPagerButtons ? a("#pData,#nData", t).show() : a("#pData,#nData", t).hide(),
                        a(s).triggerHandler("jqGridAddEditBeforeShowForm", [a(y), w]),
                        a.isFunction(b[s.p.id].beforeShowForm) && b[s.p.id].beforeShowForm.call(s, a(y), w),
                        r(),
                        a("#" + a.jgrid.jqID(B.themodal)).data("onClose", b[s.p.id].onClose),
                        ...
                        a("#sData", t).click(function() {
                            ...
                            a(".FormError", y).hide(),
                            e(),
                            "_empty" === u[s.p.id + "_id"] ? k() : !0 === d.checkOnSubmit ? (v = l(u, s.p.savedData), v ? (a(y).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(B.themodal)).show()) : k()) : k(),
                            !1
                        }),
                        ...
                        a(t).find("[data-index]").each(function() {
                            ...
                            c >= 0 && d.buttons[c].hasOwnProperty("click") && a(this).on("click",
                            function(e) {
                        ...
                        a("#nData", t).click(function() {
                            ...
                            if (c[0] = parseInt(c[0], 10), -1 !== c[0] && c[1][c[0] + 1]) {
                                ...
                                i(c[1][c[0] + 1], s, y),
                                s.p.multiselect && b[s.p.id].editselected || a(s).jqGrid("setSelection", c[1][c[0] + 1]),
                                a(s).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", a(y), c[1][c[0]]]),
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(s, "next", a(y), c[1][c[0] + 1]),
                                r(),
                                o(c[0] + 1, c)
                            }
                            return ! 1
                        ...
                        a("#pData", t).click(function() {
                            ...
                            if ( - 1 !== c[0] && c[1][c[0] - 1]) {
                                ...
                                i(c[1][c[0] - 1], s, y),
                                s.p.multiselect && b[s.p.id].editselected || a(s).jqGrid("setSelection", c[1][c[0] - 1]),
                                a(s).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", a(y), c[1][c[0]]]),
                                a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(s, "prev", a(y), c[1][c[0] - 1]),
                                r(),
                                o(c[0] - 1, c)
                            }
                            return ! 1
                        ...
                        a.isFunction(b[s.p.id].afterShowForm) && b[s.p.id].afterShowForm.call(s, a(y), w);
                        var $ = p();
                        o($[0], $)
                    }
                }
        ...
        viewGridRow: function(c, d) {
            ...
            b[a(this)[0].p.id] = d,
            this.each(function() {
                function e() { ! 0 !== b[l.p.id].closeOnEscape && !0 !== b[l.p.id].navkeys[0] || setTimeout(function() {
                ...
                function f(b, c, e, f) {
                    ...
                    if (a(c.p.colModel).each(function() { (i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden) || "right" !== this.align || (this.formatter && -1 !== a.inArray(this.formatter, w) ? x = Math.max(x, parseInt(this.width, 10)) : y = Math.max(y, parseInt(this.width, 10)))
                        ...
                        if (g = this.name, o = !1, i = (!this.editrules || !0 !== this.editrules.edithidden) && !0 === this.hidden, l = i ? "style='display:none'": "", p = "boolean" != typeof this.viewable || this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && p) {
                            k = !1 === s ? "": g === c.p.ExpandColumn && !0 === c.p.treeGrid ? a("td:eq(" + b + ")", c.rows[s]).text() : a("td:eq(" + b + ")", c.rows[s]).html(),
                ...
                function i(b, c) {
                    var d, e, f, g, h = 0; (g = a(c).jqGrid("getInd", b, !0)) && (a("td", g).each(function(b) {
                        d = c.p.colModel[b].name,
                        e = (!c.p.colModel[b].editrules || !0 !== c.p.colModel[b].editrules.edithidden) && !0 === c.p.colModel[b].hidden,
                        "cb" !== d && "subgrid" !== d && "rn" !== d && (f = d === c.p.ExpandColumn && !0 === c.p.treeGrid ? a(this).text() : a(this).html(), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + o).html(f), e && a("#" + d, "#" + o).parents("tr:first").hide(), h++)
                    }), h > 0 && a("#id_g", "#" + o).val(b))
                }
                function j(b, c) {
                    var d = c[1].length - 1;
                ...
                if (l.grid && c) {
                    ...
                    if (a(l.p.colModel).each(function() {
                        ...
                        z && (a("#pData, #nData", "#" + o + "_2").css("float", "right"), a(".EditButton", "#" + o + "_2").css("text-align", "left")),
                        ...
                        !0 === d.closeicon[0] && a("#cData", "#" + o + "_2").addClass("right" === d.closeicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='" + h.icon_base + " " + d.closeicon[2] + "'></span>"),
                        a(l).triggerHandler("jqGridViewRowBeforeShowForm", [a("#" + n)]),
                        ...
                        a("#nData", "#" + o + "_2").click(function() {
                            ...
                            -1 !== b[0] && b[1][b[0] + 1] && (a(l).triggerHandler("jqGridViewRowClickPgButtons", ["next", a("#" + n), b[1][b[0]]]), a.isFunction(d.onclickPgButtons) && d.onclickPgButtons.call(l, "next", a("#" + n), b[1][b[0]]), i(b[1][b[0] + 1], l), a(l).jqGrid("setSelection", b[1][b[0] + 1]), a(l).triggerHandler("jqGridViewRowAfterClickPgButtons", ["next", a("#" + n), b[1][b[0] + 1]]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(l, "next", a("#" + n), b[1][b[0] + 1]), j(b[0] + 1, b)),
                            e(),
                            !1
                        }),
            ...
            this.each(function() {
                ...
                if (e.grid && c) {
                    ...
                    if (b[e.p.id].styleUI = e.p.styleUI || "jQueryUI", a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(q.themodal))[0]) {
                        ...
                        a("#DelError", "#" + o).hide(),
                        !0 === b[e.p.id].processing && (b[e.p.id].processing = !1, a("#dData", "#" + o).removeClass(h.active)),
                        a(e).triggerHandler("jqGridDelRowBeforeShowForm", [a("#" + o)]),
                        a.isFunction(b[e.p.id].beforeShowForm) && b[e.p.id].beforeShowForm.call(e, a("#" + o)),
                        ...
                        a.isFunction(b[e.p.id].afterShowForm) && b[e.p.id].afterShowForm.call(e, a("#" + o))
                    } else {
                        ...
                        t += "<tr id='DelError' style='display:none'><td class='" + h.error + "'></td></tr>",
                        t += "<tr id='DelData' style='display:none'><td >" + c + "</td></tr>",
                        t += '<tr><td class="delmsg" style="white-space:pre;">' + b[e.p.id].msg + "</td></tr><tr><td >&#160;</td></tr>",
                        t += "</tbody></table></div>";
                        ...
                        function() {
                            ...
                            if (m = {},
                            m = a(e).triggerHandler("jqGridDelRowClickSubmit", [b[e.p.id], n]), void 0 === m && a.isFunction(b[e.p.id].onclickSubmit) && (m = b[e.p.id].onclickSubmit.call(e, b[e.p.id], n) || {}), g = a(e).triggerHandler("jqGridDelRowBeforeSubmit", [n]), void 0 === g && (g = [!0, "", ""]), g[0] && a.isFunction(b[e.p.id].beforeSubmit) && (g = b[e.p.id].beforeSubmit.call(e, n)), g[0] && !b[e.p.id].processing) {
                                if (b[e.p.id].processing = !0, j = e.p.prmNames, f = a.extend({},
                                b[e.p.id].delData, m), k = j.oper, f[k] = j.deloper, i = j.id, n = String(n).split(","), !n.length) return ! 1;
                                ...
                                var p = a.extend({
                                    ...
                                    complete: function(c, i) {
                                        var j;
                                        if (a("#dData", "#" + o + "_2").removeClass(h.active), c.status >= 300 && 304 !== c.status ? (g[0] = !1, g[1] = a(e).triggerHandler("jqGridDelRowErrorTextFormat", [c]), a.isFunction(b[e.p.id].errorTextFormat) && (g[1] = b[e.p.id].errorTextFormat.call(e, c)), void 0 === g[1] && (g[1] = i + " Status: '" + c.statusText + "'. Error code: " + c.status)) : (g = a(e).triggerHandler("jqGridDelRowAfterSubmit", [c, f]), void 0 === g && (g = [!0, "", ""]), g[0] && a.isFunction(b[e.p.id].afterSubmit) && (g = b[e.p.id].afterSubmit.call(e, c, f))), !1 === g[0]) a("#DelError>td", "#" + o).html(g[1]),
                                        a("#DelError", "#" + o).show();
                                        else {
                                        ...
                                        g[0] && a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {
                                ...
                                if (p.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (g[0] = !1, g[1] += " " + a.jgrid.getRegional(e, "errors.nourl"))), g[0]) if (b[e.p.id].useDataProxy) {
                                    ...
                                    void 0 === r && (r = [!0, ""]),
                                    !1 === r[0] ? (g[0] = !1, g[1] = r[1] || "Error deleting the selected row!") : a.jgrid.hideModal("#" + a.jgrid.jqID(q.themodal), {
                                        gb: "#gbox_" + a.jgrid.jqID(l),
                                        jqm: d.jqModal,
                                        onClose: b[e.p.id].onClose
                                    })
                            ...
                            return ! 1 === g[0] && (a("#DelError>td", "#" + o).html(g[1]), a("#DelError", "#" + o).show()),
                            !1
            ...
            this.each(function() {
                if (!this.p.navGrid) {
                    ...
                    if (p.grid && "string" == typeof b) {
                        if (a(p).data("navGrid") || a(p).data("navGrid", c), n = a(p).data("navGrid"), p.p.force_regional && (n = a.extend(n, i)), void 0 === a("#" + o.themodal)[0]) {
                            n.alerttop || n.alertleft || (void 0 !== window.innerWidth ? (n.alertleft = window.innerWidth, n.alerttop = window.innerHeight) : void 0 !== document.documentElement && void 0 !== document.documentElement.clientWidth && 0 !== document.documentElement.clientWidth ? (n.alertleft = document.documentElement.clientWidth, n.alerttop = document.documentElement.clientHeight) : (n.alertleft = 1024, n.alerttop = 768), n.alertleft = n.alertleft / 2 - parseInt(n.alertwidth, 10) / 2, n.alerttop = n.alerttop / 2 - 25);
                        ...
                        for (n.cloneToTop && p.p.toppager && (s = 2), r = 0; r < s; r++) {
                            var v, w, x, y = a("<table class='ui-pg-table navtable ui-common-table'><tbody><tr></tr></tbody></table>"),
                            z = "<td class='ui-pg-button " + l.disabled + "' style='width:4px;'><span class='ui-separator'></span></td>";
                            0 === r ? (w = b, x = p.p.id, w === p.p.toppager && (x += "_top", s = 1)) : (w = p.p.toppager, x = p.p.id + "_top"),
                            "rtl" === p.p.direction && a(y).attr("dir", "rtl").css("float", "right"),
                            e = e || {},
                            n.add && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.addicon + "'></span>" + n.addtext + "</div>"), a("tr", y).append(v), a(v, y).attr({
                                title: n.addtitle || "",
                                id: e.id || "add_" + x
                            }).click(function() {
                            ...
                            d = d || {},
                            n.edit && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.editicon + "'></span>" + n.edittext + "</div>"), a("tr", y).append(v), a(v, y).attr({
                                title: n.edittitle || "",
                                id: d.id || "edit_" + x
                            }).click(function() {
                            ...
                            h = h || {},
                            n.view && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.viewicon + "'></span>" + n.viewtext + "</div>"), a("tr", y).append(v), a(v, y).attr({
                                title: n.viewtitle || "",
                                id: h.id || "view_" + x
                            }).click(function() {
                                if (!a(this).hasClass(l.disabled)) {
                            ...
                            f = f || {},
                            n.del && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.delicon + "'></span>" + n.deltext + "</div>"), a("tr", y).append(v), a(v, y).attr({
                                title: n.deltitle || "",
                                id: f.id || "del_" + x
                            }).click(function() {
                                if (!a(this).hasClass(l.disabled)) {
                            ...
                            g = g || {},
                            n.search && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.searchicon + "'></span>" + n.searchtext + "</div>"), a("tr", y).append(v), a(v, y).attr({
                                title: n.searchtitle || "",
                                id: g.id || "search_" + x
                            }).click(function() {
                                return a(this).hasClass(l.disabled) || (a.isFunction(n.searchfunc) ? n.searchfunc.call(p, g) : a(p).jqGrid("searchGrid", g)),
                                !1
                            }).hover(t, u), g.showOnLoad && !0 === g.showOnLoad && a(v, y).click(), v = null),
                            n.refresh && (v = a("<td class='ui-pg-button " + l.cornerall + "'></td>"), a(v).append("<div class='ui-pg-div'><span class='" + l.icon_base + " " + n.refreshicon + "'></span>" + n.refreshtext + "</div>"), a("tr", y).append(v), a(v, y).attr({
                            ...
                            a("#testpg2").remove(),
                            p.p._nvtd && (n.dropmenu ? (y = null, a(p).jqGrid("_buildNavMenu", w, x, c, d, e, f, g, h)) : k > p.p._nvtd[0] ? (p.p.responsive ? (y = null, a(p).jqGrid("_buildNavMenu", w, x, c, d, e, f, g, h)) : a(w + "_" + n.position, w).append(y).width(k), p.p._nvtd[0] = k) : a(w + "_" + n.position, w).append(y), p.p._nvtd[1] = k),
                            p.p.navGrid = !0
                        }
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    if (f.p.storeNavOptions && !c.internal && f.p.navButtons.push([b, c]), e) {
                        ...
                        var k = a("<td></td>");
                        "NONE" === c.buttonicon.toString().toUpperCase() ? a(k).addClass("ui-pg-button " + i).append("<div class='ui-pg-div'>" + c.caption + "</div>") : a(k).addClass("ui-pg-button " + i).append("<div class='ui-pg-div'><span class='" + j + " " + c.buttonicon + "'></span>" + c.caption + "</div>"),
        ...
        _buildNavMenu: function(b, c, d, e, f, g, h, i) {
            return this.each(function() {
                ...
                var r = {
                    ...
                    var b, k, l = a(".ui-jqgrid").css("font-size") || "11px",
                    ...
                    b = h.id || "search_" + c, k = a('<li class="ui-menu-item" role="presentation"><a class="' + n.cornerall + ' g-menu-item" tabindex="0" role="menuitem" id="' + b + '">' + (d.searchtext || d.searchtitle) + "</a></li>").click(function() {
                        ...
                        !1
                    }), a(p).append(k), h.showOnLoad && !0 === h.showOnLoad && a(k).click()),
...
function(a) {
    ...
    a.fn.jqFilter = function(b) {
        ...
        return this.each(function() {
            if (!this.filter) {
                ...
                this.p.filter), d) {
                    for (b = 0; b < d; b++) c = this.p.columns[b],
                    ...
                    this.onchange = function() {
                        ...
                        this.p.errmsg = "",
                        !!a.isFunction(this.p.onChange) && this.p.onChange.call(this, this.p)
                    },
                    ...
                    this.createTableForGroup = function(b, c) {
                        ...
                        var p = "<span></span>";
                        if (this.p.groupButton && (p = a("<input type='button' value='+ {}' title='" + f.p.subgroup + "' class='add-group " + j.button + "'/>"), p.on("click",
                        function() {
                            ...
                            var q, r = a("<input type='button' value='+' title='" + f.p.addrule + "' class='add-rule ui-add " + j.button + "'/>");
                            r.on("click",
                            function() {
                                for (void 0 === b.rules && (b.rules = []), d = 0; d < f.p.columns.length; d++) {
                                    var c = void 0 === f.p.columns[d].search || f.p.columns[d].search,
                                ...
                                if (!q) return ! 1;
                                var g;
                                return g = q.searchoptions.sopt ? q.searchoptions.sopt: f.p.sopt ? f.p.sopt: -1 !== a.inArray(q.searchtype, f.p.strarr) ? f.p.stropts: f.p.numopts,
                                b.rules.push({
                                    field: q.name,
                                    op: g[0],
                                    data: ""
                        ...
                        var w, x = f.p.ruleButtons && f.p.uniqueSearchFields;
                        if (x) for (w = 0; w < f.p.columns.length; w++) f.p.columns[w].inlist && (f.p.columns[w].search = !0);
                        if (void 0 !== b.rules) for (d = 0; d < b.rules.length; d++) if (g.append(this.createTableRowForRule(b.rules[d], b)), x) {
                    ...
                    this.createTableRowForRule = function(b, c) {
                        ...
                        p.append(r);
                        var s, t = a("<select size='1' class='" + i.srSelect + "'></select>"),
                        u = [];
                        r.append(t),
                        t.on("change",
                        function() {
                            ...
                            if (l) {
                                ...
                                var g = a.jgrid.createEl.call(o, l.inputtype, l.searchoptions, "", !0, n.p.ajaxSelectOptions || {},
                                !0);
                                ...
                                a(".input-elm", k).on("change",
                                function(c) {
                                    var d = c.target;
                                    "custom" === l.inputtype && a.isFunction(l.searchoptions.custom_value) ? b.data = l.searchoptions.custom_value.call(o, a(".customelement", this), "get") : b.data = a(d).val(),
                                    "select" === l.inputtype && l.searchoptions.multiple && (b.data = b.data.join(",")),
                                    n.onchange()
                                }),
                                setTimeout(function() {
                                    b.data = a(g).val(),
                        ...
                        for (d = 0; d < n.p.columns.length; d++) {
                            var w = void 0 === n.p.columns[d].search || n.p.columns[d].search,
                            x = !0 === n.p.columns[d].hidden; (!0 === n.p.columns[d].searchoptions.searchhidden && w || w && !x) && (m = "", b.field === n.p.columns[d].name && (m = " selected='selected'", v = d), q += "<option value='" + n.p.columns[d].name + "'" + m + ">" + n.p.columns[d].label + "</option>")
                        }
                        t.append(q),
                        t.data("curr", v);
                        ...
                        a(z).addClass("input-elm " + i.srInput).on("change",
                        function() {
                            b.data = "custom" === l.inputtype ? l.searchoptions.custom_value.call(o, a(".customelement", this), "get") : a(this).val(),
                            n.onchange()
                        });
                        var C = a("<td></td>");
                    ...
                    this.getStringForRule = function(b) {
                        ...
                        for (c = 0; c < this.p.ops.length; c++) if (this.p.ops[c].oper === b.op) {
                            g = this.p.operands.hasOwnProperty(b.op) ? this.p.operands[b.op] : "",
                            h = this.p.ops[c].oper;
                            break
                        }
                        ...
                        return void 0 === d ? "": (f = this.p.autoencode ? a.jgrid.htmlEncode(b.data) : b.data, "bw" !== h && "bn" !== h || (f += "%"), "ew" !== h && "en" !== h || (f = "%" + f), "cn" !== h && "nc" !== h || (f = "%" + f + "%"), "in" !== h && "ni" !== h || (f = " (" + f + ")"), e.errorcheck && k(b.data, d), -1 !== a.inArray(d.searchtype, i) || "nn" === h || "nu" === h ? b.field + " " + g + " " + f: b.field + " " + g + ' "' + f + '"')
                    },
                    ...
                    this.toString = function() {
                        ...
                        function b(c) {
                            var d, e = "(";
                            if (void 0 !== c.groups) for (d = 0; d < c.groups.length; d++) e.length > 1 && ("OR" === c.groupOp ? e += " || ": e += " && "),
                            e += b(c.groups[d]);
                            if (void 0 !== c.rules) for (d = 0; d < c.rules.length; d++) e.length > 1 && ("OR" === c.groupOp ? e += " || ": e += " && "),
                            e += a(c.rules[d]);
                            return e += ")",
                            "()" === e ? "": e
                        }
    ...
    a.extend(a.jgrid, {
        filterRefactor: function(b) {
            var c, d, e, f, g, h = {};
            try {
                if (h = "string" == typeof b.ruleGroudp ? a.jgrid.parse(b.ruleGroup) : b.ruleGroup, h.rules && h.rules.length) for (c = h.rules, d = 0; d < c.length; d++) e = c[d],
                a.inArray(e.filed, b.ssfield) && (f = e.data.split(b.splitSelect), f.length > 1 && (void 0 === h.groups && (h.groups = []), g = {
                    groupOp: b.groupOpSelect,
                    groups: [],
                    rules: []
                },
                h.groups.push(g), a.each(f,
                function(a) {
                    f[a] && g.rules.push({
                        data: f[a],
                        op: e.op,
    ...
    a.jgrid.extend({
            ...
            this.each(function() {
                ...
                if (!d.p.filterToolbar) {
                    ...
                    k = function() {
                        ...
                        function() {
                            ...
                            if (!0 === b.stringResult || "local" === d.p.datatype || !0 === b.searchOperators) {
                                ...
                                }), m && (a.isPlainObject(s) || (s = a.jgrid.parse(q)), s.rules && s.rules.length)) for (t = s.rules, u = 0; u < t.length; u++) w = t[u],
                                "bt" === w.op && (x = w.data.split("..."), x.length > 1 && (void 0 === s.groups && (s.groups = []), y = {
                                    groupOp: "AND",
                                    groups: [],
                                    rules: []
                                },
                                s.groups.push(y), a.each(x,
                                function(a) {
                                    var b = 0 === a ? "ge": "le"; (v = x[a]) && y.rules.push({
                                        data: x[a],
                                        op: b,
                                        field: w.field
                                    })
                                }), t.splice(u, 1), u--)); (m || k) && (q = JSON.stringify(s)),
                            ...
                            var A = "stop" === a(d).triggerHandler("jqGridToolbarBeforeSearch"); ! A && a.isFunction(b.beforeSearch) && (A = b.beforeSearch.call(d)),
                            A || a(d).jqGrid("setGridParam", {
                                search: p
                            }).trigger("reloadGrid", [{
                                page: 1
                            }]),
                    ...
                    l = function(c) {
                        ...
                        function() {
                            ...
                            case "select":
                                if (c.find("option").each(function(c) {
                                    if (0 === c && (this.selected = !0), a(this).val() === b) return this.selected = !0,
                                    !1
                                }), void 0 !== b) f[e] = b,
                                g++;
                                else try {
                        ...
                        var l = "stop" === a(d).triggerHandler("jqGridToolbarBeforeClear"); ! l && a.isFunction(b.beforeClear) && (l = b.beforeClear.call(d)),
                    ...
                    m = function() {
                        var b = a("tr.ui-search-toolbar", d.grid.hDiv); ! 0 === d.p.frozenColumns && a(d).jqGrid("destroyFrozenColumns"),
                    ...
                    b.restoreFromFilters && (g = d.p.postData.filters) && ("string" == typeof g && (g = a.jgrid.parse(g)), f = !!g.rules.length && g.rules),
                    a.each(d.p.colModel,
                    function(c) {
                        ...
                        if (!0 === this.hidden && a(v).css("display", "none"), this.search = !1 !== this.search, void 0 === this.stype && (this.stype = "text"), this.searchoptions = this.searchoptions || {},
                        void 0 === this.searchoptions.searchOperMenu && (this.searchoptions.searchOperMenu = !0), g = a.extend({},
                        this.searchoptions, {
                            name: s.index || s.name,
                            ...
                            if (b.searchOperators) {
                                ...
                                t = this.searchoptions.searchOperMenu ? "<a title='" + m + "' style='padding-right: 0.5em;' soper='" + i + "' class='soptclass' colname='" + this.name + "'>" + u + "</a>": ""
                            }
                            ...
                            a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), a(q).addClass(h.srInput), a("td:eq(1)", x).append(q), a(w).append(x), null == g.dataEvents && (g.dataEvents = []), this.stype) {
                            case "select":
                    ...
                    a(".clearsearchclass", o).click(function() {
                        var c, e = a(this).parents("tr:first"),
                        f = parseInt(a("td.ui-search-oper", e).attr("colindex"), 10),
                        g = a.extend({},
                        d.p.colModel[f].searchoptions || {}),
                        h = g.defaultValue ? g.defaultValue: "";
                        "select" === d.p.colModel[f].stype ? (c = a("td.ui-search-input select", e), h ? c.val(h) : c[0].selectedIndex = 0) : (c = a("td.ui-search-input input", e), c.val(h)),
                        a(d).triggerHandler("jqGridToolbarClearVal", [c[0], f, g, h]),
                        a.isFunction(b.onClearSearchValue) && b.onClearSearchValue.call(d, c[0], f, g, h),
                        !0 === b.autosearch && k()
                    }),
        ...
        refreshFilterToolbar: function(b) {
            ...
            this.each(function() {
                function c(f) {
                    if (f && f.rules) {
                        for (g = f.rules, l = g.length, d = 0; d < l; d++) h = g[d],
                        -1 !== (i = a.inArray(h.field, m)) && (e = a("#gs_" + j.p.idPrefix + a.jgrid.jqID(k[i].name)), e.length > 0 && ("select" === k[i].stype ? e.find("option[value='" + a.jgrid.jqID(h.data) + "']").prop("selected", !0) : "text" === k[i].stype && e.val(h.data), a.isFunction(b.onSetVal) && b.onSetVal.call(j, e, k[i].name)));
                        if (f.groups) for (var n = 0; n < f.groups.length; n++) c(f.groups[n])
                    }
                }
                ...
                if (j.p.filterToolbar) {
                    ...
                    "string" == typeof b.filters && b.filters.length && (f = a.jgrid.parse(b.filters)),
            ...
            this.each(function() {
                ...
                if (d.grid) {
                    ...
                    if (b.styleUI = d.p.styleUI, "string" == typeof j && (j = a.jgrid.parse(j)), !0 === b.recreateFilter && a("#" + a.jgrid.jqID(i.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(i.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(d.p.id)));
                        ...
                        if (b.columns.length ? (r = b.columns, x = 0, p = r[0].index || r[0].name) : a.each(r,
                        function(a, b) {
                            if (b.label || (b.label = d.p.colNames[a]), !w) {
                                var c = void 0 === b.search || b.search,
                                e = !0 === b.hidden; (b.searchoptions && !0 === b.searchoptions.searchhidden && c || c && !e) && (w = !0, p = b.index || b.name, x = a)
                            }
                            "select" === b.stype && b.searchoptions && b.searchoptions.multiple && (y = !0, z.push(b.index || b.name))
                        }), !j && p || !1 === b.multipleSearch) {
                            var B = "eq";
                            x >= 0 && r[x].searchoptions && r[x].searchoptions.sopt ? B = r[x].searchoptions.sopt[0] : b.sopt && b.sopt.length && (B = b.sopt[0]),
                            j = {
                                groupOp: "AND",
                                rules: [{
                                    field: p,
                        ...
                        w = !1,
                        b.tmplNames && b.tmplNames.length && (w = !0, v = "<tr><td class='ui-search-label'>" + b.tmplLabel + "</td>", v += "<td><select size='1' class='ui-template " + k.srSelect + "'>", v += "<option value='default'>Default</option>", a.each(b.tmplNames,
                        function(a, b) {
                            v += "<option value='" + a + "'>" + b + "</option>"
                        }), v += "</select></td></tr>"),
                        q = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + f + "_2'><tbody><tr><td colspan='2'><hr class='" + l.content + "' style='margin:1px'/></td></tr>" + v + "<tr><td class='EditButton' style='text-align:" + n + "'>" + t + "</td><td class='EditButton' " + o + ">" + A + "</td></tr></tbody></table>",
                        f = a.jgrid.jqID(f),
                        a("#" + f).jqFilter({
                            columns: r,
                        ...
                        m.append(q),
                        a("#" + f + "_2").find("[data-index]").each(function() {
                            var c = parseInt(a(this).attr("data-index"), 10);
                            c >= 0 && a(this).on("click",
                            function(e) {
                        ...
                        w && b.tmplFilters && b.tmplFilters.length && a(".ui-template", m).on("change",
                        function() {
                            var c = a(this).val();
                        ...
                        b.layer ? a.jgrid.createModal(i, m, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "string" == typeof b.layer ? "#" + a.jgrid.jqID(b.layer) : b.layer, "string" == typeof b.layer ? {
                            position: "relative",
                            "font-size": C
                        }: {
                            "font-size": C
                        ...
                        u && a("#" + f + "_query").on("click",
                        function() {
                            return a(".queryresult", m).toggle(),
                            !1
                        }),
                        void 0 === b.stringResult && (b.stringResult = b.multipleSearch),
                        a("#" + f + "_search").on("click",
                        function() {
                            var c, g, j = {};
                            if (e = a("#" + f), e.find(".input-elm:focus").change(), y && b.multipleSearch ? (d.p_savedFilter = {},
                            g = a.jgrid.filterRefactor({
                                ruleGroup: a.extend(!0, {},
                                e.jqFilter("filterData")),
                                ssfield: z,
                                splitSelect: b.splitSelect,
                                groupOpSelect: b.groupOpSelect
                            }), d.p_savedFilter = a.extend(!0, {},
                            e.jqFilter("filterData"))) : g = e.jqFilter("filterData"), b.errorcheck && (e[0].hideError(), b.showQuery || e.jqFilter("toSQLString"), e[0].p.error)) return e[0].showError(),
                            !1;
                            if (b.stringResult) {
                                try {
                                    c = JSON.stringify(g)
        ...
        filterInput: function(b, c) {
            ...
            this.each(function() {
                var d = this;
                if (d.grid) {
                    var e, f, g, h = '{"groupOp":"' + c.groupOp + '","rules":[',
                    i = 0;
                    if (b += "", "local" === d.p.datatype) {
                        ...
                        function() {
                            ...
                            g = c.defaultSearch ? c.defaultSearch: f.sopt ? f.sopt[0] : c.defaultSearch,
                            this.search = !1 !== this.search,
                            (this.search || c.searchAll) && (i > 0 && (h += ","), h += '{"field":"' + e + '",', h += '"op":"' + g + '",', h += '"data":"' + b.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"}', i++)
                        }),
                        h += "]}",
                        a.extend(d.p.postData, {
                            filters: h
                        ...
                        var j = "stop" === a(d).triggerHandler("jqGridFilterInputBeforeSearch"); ! j && a.isFunction(c.beforeSearch) && (j = c.beforeSearch.call(d)),
                        j || a(d).jqGrid("setGridParam", {
                            search: !0
                        }).trigger("reloadGrid", [{
                            page: 1
                        }]),
        ...
        editRow: function(b, c, d, e, f, g, h, i, j) {
            ...
            this.each(function() {
                ...
                if (m.grid && !1 !== (f = a(m).jqGrid("getInd", b, !0))) {
                    ...
                    "0" !== e || a(f).hasClass("not-editable-row") || (g = m.p.colModel, a('td[role="gridcell"]', f).each(function(e) {
                        c = g[e].name;
                        ...
                        if ("cb" !== c && "subgrid" !== c && "rn" !== c && (m.p.autoencode && (d = a.jgrid.htmlDecode(d)), l[c] = d, !0 === g[e].editable)) {
                            ...
                            ("&nbsp;" === d || "&#160;" === d || 1 === d.length && 160 === d.charCodeAt(0)) && (d = "");
                            var k = a.jgrid.createEl.call(m, g[e].edittype, h, d, !0, a.extend({},
                            a.jgrid.ajaxOptions, m.p.ajaxSelectOptions || {}));
                            a(k).addClass("editable inline-edit-cell"),
                            a.inArray(g[e].edittype, ["text", "textarea", "password", "select"]) > -1 && a(k).addClass(n),
                            f ? a("span:first", this).append(k) : a(this).append(k),
                            a.jgrid.bindEv.call(m, k, h),
                            "select" === g[e].edittype && void 0 !== g[e].editoptions && !0 === g[e].editoptions.multiple && void 0 === g[e].editoptions.dataUrl && a.jgrid.msie() && a(k).width(a(k).width()),
                            i++
                        }
                    ...
                    0)), !0 === k.keys && a(f).on(k.keyevent,
                    function(c) {
                        if (27 === c.keyCode) {
                            if (a.isFunction(k.onEscape)) return k.onEscape.call(m, b, k, c),
                            !0;
                        ...
                        if (13 === c.keyCode) {
                            ...
                            if (a.isFunction(k.onEnter)) return k.onEnter.call(m, b, k, c),
                            !0;
                ...
                if (m = a(p).attr("editable"), j.url = j.url || k.p.editurl, "1" === m) {
                    ...
                    if (a('td[role="gridcell"]', p).each(function(b) {
                        if (z = k.p.colModel[b], l = z.name, B = "", "cb" !== l && "subgrid" !== l && !0 === z.editable && "rn" !== l && !a(this).hasClass("not-editable-cell")) {
                            ...
                            case "checkbox":
                                var c = ["Yes", "No"];
                                z.editoptions && z.editoptions.value && (c = z.editoptions.value.split(":")),
                            ...
                            if (o = a.jgrid.checkValues.call(k, r[l], b), !1 === o[0]) return A = b,
                            !1;
                            k.p.autoencode && (r[l] = a.jgrid.htmlEncode(r[l])),
                            "clientArray" !== j.url && z.editoptions && !0 === z.editoptions.NullIfEmpty && "" === r[l] && (t[l] = "null", u = !0)
                        }
                    }), !1 === o[0]) {
                        try {
                    ...
                    if ("clientArray" === j.url) {
                        ...
                        var K, L = a(k).jqGrid("setRowData", b, r);
                        ...
                        a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(k, b, L, r, j),
        ...
        addRow: function(b) {
            ...
            this.each(function() {
                if (this.grid) {
                    var c = this;
                    c.p.beforeAction = !0;
                    var d = a.isFunction(b.beforeAddRow) ? b.beforeAddRow.call(c, b.addRowParams) : void 0;
                ...
                if (this.grid && !this.p.inlineNav) {
                    ...
                    c.add && a(d).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function() {
                            ...
                            !c.addParams.useFormatter && d.p.beforeAction && (a("#" + f + "_ilsave").removeClass(g), a("#" + f + "_ilcancel").removeClass(g), a("#" + f + "_iladd").addClass(g), a("#" + f + "_iledit").addClass(g))
                        }
                    }),
                    ...
                    !0 !== c.restoreAfterSelect && !0 !== c.saveAfterSelect || a(d).on("jqGridBeforeSelectRow.inlineNav",
                    function(b, e) {
                        if (d.p.savedRow.length > 0 && !0 === d.p.inlineNav && e !== d.p.selrow && null !== d.p.selrow) {
                            var f = !0;
                            d.p.selrow === c.addParams.rowID ? a(d).jqGrid("delRowData", d.p.selrow) : !0 === c.restoreAfterSelect ? a(d).jqGrid("restoreRow", d.p.selrow, c.editParams) : f = a(d).jqGrid("saveRow", d.p.selrow, c.editParams),
    ...
    a.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (j.grid && !0 === j.p.cellEdit) {
                    ...
                    if (i = j.p.colModel[c], "subgrid" !== (f = i.name) && "cb" !== f && "rn" !== f) {
                        ...
                        if (h.addClass("edit-cell " + k), a(j.rows[b]).addClass("selected-row " + l), !0 !== i.editable || !0 !== d || h.hasClass("not-editable-cell") || a.isFunction(j.p.isCellEditable) && !j.p.isCellEditable.call(j, f, b, c)) g = h.html().replace(/\&#160\;/gi, ""),
                        a(j).triggerHandler("jqGridCellSelect", [j.rows[b].id, c, g, e]),
                        a.isFunction(j.p.onCellSelect) && j.p.onCellSelect.call(j, j.rows[b].id, c, g, e);
                        else {
                            try {
                            ...
                            a(j).triggerHandler("jqGridBeforeEditCell", [j.rows[b].id, f, g, b, c]),
                            a.isFunction(j.p.beforeEditCell) && j.p.beforeEditCell.call(j, j.rows[b].id, f, g, b, c);
                            var p = a.extend({},
                            i.editoptions || {},
                            {
                                id: b + "_" + f,
                            ...
                            q = a.jgrid.createEl.call(j, i.edittype, p, g, !0, a.extend({},
                            a.jgrid.ajaxOptions, j.p.ajaxSelectOptions || {}));
                            a.inArray(i.edittype, ["text", "textarea", "password", "select"]) > -1 && a(q).addClass(m),
                            ...
                            1),
                            a("input, select, textarea", h).on("keydown",
                            function(d) {
                                if (27 === d.keyCode && (a("input.hasDatepicker", h).length > 0 ? a(".ui-datepicker").is(":hidden") ? a(j).jqGrid("restoreCell", b, c) : a("input.hasDatepicker", h).datepicker("hide") : a(j).jqGrid("restoreCell", b, c)), 13 === d.keyCode && !d.shiftKey) return a(j).jqGrid("saveCell", b, c),
                                !1;
                                if (9 === d.keyCode) {
                            ...
                            a(j).triggerHandler("jqGridAfterEditCell", [j.rows[b].id, f, g, b, c]),
                            a.isFunction(j.p.afterEditCell) && j.p.afterEditCell.call(j, j.rows[b].id, f, g, b, c)
                        }
                        j.p.iCol = c,
                        j.p.iRow = b,
                        j.p.iRowId = j.rows[b].id
                    }
                }
            })
        },
        saveCell: function(b, c) {
            return this.each(function() {
                ...
                if (d.grid && !0 === d.p.cellEdit) {
                    if (null !== e) {
                        var h, i, j = a(d).jqGrid("getGridRowById", d.p.savedRow[0].rowId),
                        k = a("td:eq(" + c + ")", j),
                        l = d.p.colModel[c],
                        m = l.name,
                        n = a.jgrid.jqID(m),
                        ...
                        case "select":
                            if (l.editoptions.multiple) {
                                ...
                                i = q.join(",")
                            } else h = a("#" + b + "_" + n + " option:selected", j).val(),
                            i = a("#" + b + "_" + n + " option:selected", j).text();
                            l.formatter && (i = h);
                            break;
                        case "checkbox":
                            var r = ["Yes", "No"];
                            l.editoptions && l.editoptions.value && (r = l.editoptions.value.split(":")),
                        ...
                        if (i !== d.p.savedRow[e].v) {
                            ...
                            if (!0 === u[0]) {
                                ...
                                if (a("input.hasDatepicker", k).length > 0 && a("input.hasDatepicker", k).datepicker("hide"), "remote" === d.p.cellsubmit) if (d.p.cellurl) {
                                    ...
                                    l.editoptions && l.editoptions.NullIfEmpty && "" === h && (h = "null", v = !0),
                                    y[m] = h;
                                    var z = d.p.prmNames,
                                    A = z.id,
                                    B = z.oper;
                                    y[A] = a.jgrid.stripPref(d.p.idPrefix, d.p.savedRow[e].rowId),
                                    y[B] = z.editoper,
                                    y = a.extend(w, y),
                                    ...
                                    a.ajax(a.extend({
                                        ...
                                        complete: function(l, p) {
                                            if (a(d).jqGrid("progressBar", {
                                                ...
                                                var q = a(d).triggerHandler("jqGridAfterSubmitCell", [d, l, y[A], m, h, b, c]) || [!0, ""]; ! 0 === q[0] && a.isFunction(d.p.afterSubmitCell) && (q = d.p.afterSubmitCell.call(d, l, y[A], m, h, b, c)),
                                                !0 === q[0] ? (v && (h = ""), a(k).empty(), a(d).jqGrid("setCell", d.p.savedRow[e].rowId, c, i, !1, !1, !0), a(k).addClass("dirty-cell"), a(j).addClass("edited"), a(d).triggerHandler("jqGridAfterSaveCell", [d.p.savedRow[e].rowId, m, h, b, c]), a.isFunction(d.p.afterSaveCell) && d.p.afterSaveCell.call(d, d.p.savedRow[e].rowId, m, h, b, c), d.p.savedRow.splice(0, 1)) : (a(d).triggerHandler("jqGridErrorCell", [l, p]), a.isFunction(d.p.errorCell) ? d.p.errorCell.call(d, l, p) : a.jgrid.info_dialog(f.errcap, q[1], g.bClose, {
                                                    styleUI: d.p.styleUI,
                                                    top: o.top + 30,
                                                    left: o.left,
                                                    onClose: function() {
                                        ...
                                        error: function(e, h, i) {
                                            ...
                                            a(d).triggerHandler("jqGridErrorCell", [e, h, i]),
                                            a.isFunction(d.p.errorCell) ? d.p.errorCell.call(d, e, h, i) : a.jgrid.info_dialog(f.errcap, e.status + " : " + e.statusText + "<br/>" + h, g.bClose, {
                                                styleUI: d.p.styleUI,
                                                top: o.top + 30,
                                                left: o.left,
                                                onClose: function() {
            ...
            return this.each(function() {
                ...
                if (d.grid && !0 === d.p.cellEdit) {
                    if (null !== e) {
                        ...
                        a(d).jqGrid("setCell", d.p.savedRow[0].rowId, c, d.p.savedRow[e].v, !1, !1, !0),
                        a(d).triggerHandler("jqGridAfterRestoreCell", [d.p.savedRow[e].rowId, d.p.savedRow[e].v, b, c]),
                        a.isFunction(d.p.afterRestoreCell) && d.p.afterRestoreCell.call(d, d.p.savedRow[e].rowId, d.p.savedRow[e].v, b, c),
        ...
        nextCell: function(b, c, d) {
            return this.each(function() {
                ...
                if (f.grid && !0 === f.p.cellEdit) {
                    for (e = c + 1; e < f.p.colModel.length; e++) if (!0 === f.p.colModel[e].editable && (!a.isFunction(f.p.isCellEditable) || f.p.isCellEditable.call(f, f.p.colModel[e].name, b, e))) {
                        g = e;
                        break
        ...
        prevCell: function(b, c, d) {
            return this.each(function() {
                ...
                g = !1;
                if (f.grid && !0 === f.p.cellEdit) {
                    for (e = c - 1; e >= 0; e--) if (!0 === f.p.colModel[e].editable && (!a.isFunction(f.p.isCellEditable) || f.p.isCellEditable.call(f, f.p.colModel[e].name, b, e))) {
                        g = e;
                        break
                    } ! 1 !== g ? a(f).jqGrid("editCell", b, g, !0, d) : f.p.savedRow.length > 0 && a(f).jqGrid("saveCell", b, c)
                }
            ...
            return this.each(function() {
                function b(b, c, e) {
                    if ("v" === e.substr(0, 1)) {
                        ...
                        "vu" === e && i < g && (a(d.grid.bDiv)[0].scrollTop = a(d.grid.bDiv)[0].scrollTop - d.rows[b].clientHeight)
                    }
                    if ("h" === e) {
...
function(a) {
    ...
    a.fn.jqm = function(d) {
        ...
        return this.each(function() {
            if (this._jqm) return c[this._jqm].c = a.extend({},
            c[this._jqm].c, d);
            b++,
            this._jqm = b,
            c[b] = {
...
function(a) {
    ...
    a.fn.tinyDraggable = function(b) {
        ...
        b);
        return this.each(function() {
            var b, d, e = a(this); (c.handle ? a(c.handle, e) : e).on({
            ...
            return this.each(function() {
                ...
                if (d.grid) {
                    ...
                    n = function(b, c) {
                        ...
                        a(o).append(e);
                        if (a(n).append(o), b && (i = d.p.jsonReader.subgrid, void 0 !== (f = a.jgrid.getAccessor(b, i.root)))) for (g = 0; g < f.length; g++) {
                    ...
                    function() {
                        ...
                        if (f = d.p.id, e = c.id, i = a("#" + f + "_" + e + "_expandedContent"), a(this).hasClass("sgcollapsed")) {
                            ...
                            if (h = a(d).triggerHandler("jqGridSubGridRowColapsed", [f + "_" + e, e]), h = !1 !== h && "stop" !== h, h && a.isFunction(d.p.subGridRowColapsed) && (h = d.p.subGridRowColapsed.call(d, f + "_" + e, e)), !1 === h) return ! 1; ! 0 === d.p.subGridOptions.reloadOnExpand ? i.remove(".ui-subgrid") : i.hasClass("ui-subgrid") && i.hide().addClass("ui-sg-collapsed").removeClass("ui-sg-expanded"),
                    ...
                    s++; ! 0 === d.p.subGridOptions.expandOnLoad && a(d.rows).filter(".jqgrow").each(function(b, c) {
                        a(c.cells[0]).click()
                    }),
    ...
    a.jgrid.extend({
        groupingSetup: function() {
            return this.each(function() {
                ...
                if (null === g || "object" != typeof g && !a.isFunction(g)) e.p.grouping = !1;
                    ...
                    !0 === g.groupColumnShow[b] ? (g.visibiltyOnNextGrouping[b] = !0, a(e).jqGrid("showCol", g.groupField[b])) : (g.visibiltyOnNextGrouping[b] = a("#" + a.jgrid.jqID(e.p.id + "_" + g.groupField[b])).is(":visible"), a(e).jqGrid("hideCol", g.groupField[b]));
        ...
        groupingPrepare: function(b, c) {
            return this.each(function() {
                ...
                m = 0;
                for (d = 0; d < l; d++) e = i.groupField[d],
                g = i.displayField[d],
                f = b[e],
                h = null == g ? null: b[g],
                null == h && (h = f),
        ...
        groupingToggle: function(b) {
            return this.each(function() {
                ...
                if (o.hasClass(k)) {
                    if (n) for (; n && !(void 0 !== (g = p(n.className)) && g <= f);) i = parseInt(a(n).attr("jqfootlevel"), 10),
                    r = !isNaN(i) && (d.showSummaryOnHide && i <= f),
                    r || a(n).hide(),
                    n = n.nextSibling,
                    s && (r || a(u).hide(), u = u.nextSibling);
                    o.removeClass(k).addClass(l),
                    q = !0
                } else {
                    if (n) for (h = void 0; n;) {
        ...
        groupingRender: function(b, c, d, e) {
            return this.each(function() {
                ...
                function g(b, d, e, g, h) {
                    var i, j, l, m, n = f(b, d, e),
                    o = k.p.colModel,
                    p = n.cnt,
                    q = "",
                    r = !1;
                    for (j = g; j < c; j++) o[j].hidden ? l = "<td " + k.formatCol(j, 1, "") + ">&#160;</td>": !r && h ? (l = h, r = !0) : l = "<td " + k.formatCol(j, 1, "") + ">&#160;</td>",
                    a.each(n.summary,
                    function() {
                        if (this.nm === o[j].name) {
                            m = o[j].summaryTpl ? o[j].summaryTpl: "{0}",
                            "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v = this.v / this.vd: this.v && p > 0 && (this.v = this.v / p));
                            try {
                            ...
                            return l = "<td " + k.formatCol(j, 1, "") + ">" + a.jgrid.template(m, i, n.cnt, n.dataIndex, n.displayValue) + "</td>",
                            !1
                        }
                    }),
                    q += l;
                ...
                function(f, v) {
                    ...
                    if (w = a.isFunction(l.groupText[v.idx]) ? l.groupText[v.idx].call(k, j, v.cnt, v.summary) : a.jgrid.template(l.groupText[v.idx], j, v.cnt, v.summary), "string" != typeof w && "number" != typeof w && (w = j), "header" === l.groupSummaryPos[v.idx] ? (m += '<tr id="' + h + '"' + (l.groupCollapse && v.idx > 0 ? ' style="display:none;" ': " ") + 'role="row" class= "' + r.content + " jqgroup ui-row-" + k.p.direction + " " + i + '">', m += g(f, 0, l.groups, "" === s ? 0 : 1, '<td style="padding-left:' + 12 * v.idx + 'px;"' + s + ">" + n + w + "</td>"), m += "</tr>") : m += '<tr id="' + h + '"' + (l.groupCollapse && v.idx > 0 ? ' style="display:none;" ': " ") + 'role="row" class= "' + r.content + " jqgroup ui-row-" + k.p.direction + " " + i + '"><td style="padding-left:' + 12 * v.idx + 'px;" colspan="' + (!1 === l.groupColumnShow[v.idx] ? c - 1 : c) + '">' + n + w + "</td></tr>", q - 1 === v.idx) {
                        var x, y, z = l.groups[f + 1],
                        A = 0,
                        B = v.startRow,
                        C = void 0 !== z ? z.startRow: l.groups[f].startRow + l.groups[f].cnt;
                        ...
                        if ("header" !== l.groupSummaryPos[v.idx]) {
                            ...
                            for (y = 0; y < t; y++) if (u[y]) {
                                var E = "";
                                l.groupCollapse && !l.showSummaryOnHide && (E = ' style="display:none;"'),
                                m += "<tr" + E + ' jqfootlevel="' + (v.idx - y) + '" role="row" class="' + r.content + " jqfoot ui-row-" + k.p.direction + '">',
        ...
        setGroupHeaders: function(b) {
            ...
            this.each(function() {
                ...
                a(q).on("jqGridResizeStop.setGroupHeaders",
                function(a, b, c) {
...
function(a) {
    ...
    a.jgrid.extend({
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                if (d.grid && d.p.treeGrid) {
                    var e, f, g, h, i, j, k, l, m = d.p.expColInd,
                    ...
                    for (a(d).triggerHandler("jqGridBeforeSetTreeNode", [t, c]), a.isFunction(d.p.beforeSetTreeNode) && d.p.beforeSetTreeNode.call(d, t, c); b < c;) {
                        ...
                        void 0 !== k[r] && ("true" === k[r] || !0 === k[r] ? k[r] = !0 : k[r] = !1),
                        "true" === k[o] || !0 === k[o] ? (j += (void 0 !== k[q] && "" !== k[q] ? k[q] : d.p.treeIcons.leaf) + " tree-leaf treeclick", k[o] = !0, l = "leaf") : (k[o] = !1, l = ""),
                        k[n] = ("true" === k[n] || !0 === k[n]) && (k[r] || void 0 === k[r]),
                        !1 === k[n] ? j += !0 === k[o] ? "'": d.p.treeIcons.plus + " tree-plus treeclick'": j += !0 === k[o] ? "'": d.p.treeIcons.minus + " tree-minus treeclick'",
                        j += "></div></div>",
                        a(d.rows[b].cells[m]).wrapInner("<span class='cell-wrapper" + l + "'></span>").prepend(j),
                        g !== parseInt(d.p.tree_root_level, 10) && (a(d).jqGrid("isVisibleNode", k) || a(d.rows[b]).css("display", "none")),
                        a(d.rows[b].cells[m]).find("div.treeclick").on("click",
                        function(b) {
                        ...
                        !0 === d.p.ExpandColClick && a(d.rows[b].cells[m]).find("span.cell-wrapper").css("cursor", "pointer").on("click",
                        function(b) {
                            var c = b.target || b.srcElement,
                            e = a.jgrid.stripPref(d.p.idPrefix, a(c, d.rows).closest("tr.jqgrow")[0].id),
                            f = d.p._index[e];
                    ...
                    a.isFunction(d.p.afterSetTreeNode) && d.p.afterSetTreeNode.call(d, t, c)
                }
            })
        },
        setTreeGrid: function() {
            return this.each(function() {
                ...
                if (f.p.treeGrid) {
                    ...
                    f.p.subGrid = !1,
                    f.p.altRows = !1,
                    f.p.treeGrid_bigData || (f.p.pgbuttons = !1, f.p.pginput = !1, f.p.rowList = []),
                    f.p.gridview = !0,
        ...
        expandRow: function(b) {
            this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    void 0 === h && (h = !0),
                    h && a.isFunction(c.p.beforeExpandTreeGridRow) && (h = c.p.beforeExpandTreeGridRow.call(c, g, b, e)),
                    !1 !== h && (a(e).each(function() {
        ...
        collapseRow: function(b) {
            this.each(function() {
                ...
                if (c.grid && c.p.treeGrid) {
                    ...
                    void 0 === g && (g = !0),
                    g && a.isFunction(c.p.beforeCollapseTreeGridRow) && (g = c.p.beforeCollapseTreeGridRow.call(c, f, b, d)),
                    !1 !== g && (a(d).each(function() {
                        var b = c.p.idPrefix + a.jgrid.getAccessor(this, c.p.localReader.id);
            ...
            return this.each(function() {
                ...
                case "nested":
                    ...
                    a(this.p.data).each(function() {
                        if (parseInt(this[g], 10) === j - 1 && parseInt(this[e], 10) < h && parseInt(this[f], 10) > i) return c = this,
                        !1
                    });
                    break;
                case "adjacency":
                    ...
                    m = b[l], n = d.p._index[m]; n--;) if (String(d.p.data[n][l]) === String(a.jgrid.stripPref(d.p.idPrefix, b[k]))) {
                        c = d.p.data[n];
                        break
                    }
                }
        ...
        setLeaf: function(b, c, d) {
            return this.each(function() {
                ...
                if (!0 === c) a("div.treeclick", f).removeClass(this.p.treeIcons.minus + " tree-minus " + this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.leaf + " tree-leaf");
                    ...
                    a("div.treeclick", f).removeClass(this.p.treeIcons.leaf + " tree-leaf").addClass(i)
                }
            })
        },
        reloadNode: function(b, c) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    void 0 === c && (c = !1),
                    c || jQuery._data(this, "events").jqGridAfterSetTreeNode || a(this).on("jqGridAfterSetTreeNode.reloadNode",
                    function() {
                    ...
                    b[f] = !0,
                    b[j] || a("div.treeclick", n).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"),
                    this.p.treeANode = n.rowIndex,
                    this.p.datatype = this.p.treedatatype,
                    this.p.reloadnode = b,
                    c && (this.p.treeANode = n.rowIndex > 0 ? n.rowIndex - 1 : 1, a(this).jqGrid("delRowData", m)),
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (!b[d]) {
                        ...
                        a.isFunction(this.p.afterExpandTreeGridNode) && this.p.afterExpandTreeGridNode.call(this, j, b)
                    }
                }
            })
        },
            ...
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (b[c]) {
                        ...
                        a.isFunction(this.p.afterCollapseTreeGridNode) && this.p.afterCollapseTreeGridNode.call(this, e, b)
                    }
                }
            })
        },
        SortTree: function(b, c, d, e) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    ...
                    for (i = a.jgrid.from.call(this, m), i.orderBy(b, c, d, e), j = i.select(), f = 0, g = j.length; f < g; f++) h = j[f],
                    k.push(h),
        ...
        searchTree: function(b) {
            var c, d, e, f, g, h, i = b.length || 0,
            j = [],
            k = [],
            l = [];
            return this.each(function() {
                if (this.grid && this.p.treeGrid && i) for (c = this.p.localReader.id; i--;) if (j = a(this).jqGrid("getNodeAncestors", b[i], !0, !0), j.push(b[i]), d = j[0][c], -1 === a.inArray(d, k)) k.push(d),
                l = l.concat(j);
        ...
        collectChildrenSortTree: function(b, c, d, e, f, g) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var h, i, j, k, l, m;
                    for (k = a(this).jqGrid("getNodeChildren", c, this.p.search), l = a.jgrid.from.call(this, k), l.orderBy(d, e, f, g), m = l.select(), h = 0, i = m.length; h < i; h++) j = m[h],
                    b.push(j),
        ...
        addChildNode: function(b, c, d, e) {
            ...
            if (d) {
                ...
                if (void 0 === e && (e = !1), null == b) {
                    if ((k = f.p.data.length - 1) >= 0) for (; k >= 0;) v = Math.max(v, parseInt(f.p.data[k][f.p.localReader.id], 10)),
                    k--;
                    b = v + 1
                }
            ...
            return this.each(function() {
                ...
                function o(b, c, d, e) {
                    ...
                    for (a.isArray(d) ? (l = d.length, s = d) : (l = 1, s[0] = d), h = [], i = [], h.root = 0, k = 0; k < l; k++) {
                        var u, v = [];
                        for (g = 0; g < p; g++) {
                            if (m = "string" == typeof c[g].aggregator ? c[g].aggregator: "cust", null == d) j = a.trim(c[g].member) + "_" + m,
                            u = j,
                            ...
                            "avg" === c[g].aggregator && (o = -1 === r ? f.length + "_" + j: r + "_" + j, F[o] ? F[o]++:F[o] = 1, t = F[o]),
                            ...
                            if ("level" === d) {
                                if (void 0 === N[a.level] && (N[a.level] = "", a.level > 0 && -1 === a.text.indexOf("_r_Totals") && (k[a.level - 1] = {
                                    ...
                                    if (a.level - 1 == (l.rowTotals ? 1 : 0) && h > 0) {
                                        for (var j = 0,
                                        m = 0; m < h; m++) j += k[a.level - 1].groupHeaders[m].numberOfColumns;
                                        j && (i = j + t)
                                    }
                ...
                F = []; A < z;) {
                    ...
                    if (r = -1, x = d(f, m, G)) {
                        if (r >= 0) {
                            if (I = 0, u >= 1) {
                                for (I = 0; I < u; I++) H[I] = a.trim(q[l.yDimension[I].dataName]),
                                l.yDimension[I].converter && a.isFunction(l.yDimension[I].converter) && (H[I] = l.yDimension[I].converter.call(this, H[I], G, H));
                    ...
                    for (J in h) if (h.hasOwnProperty(J)) {
                        if (0 === K) E.children && void 0 !== E.children || (E = {
                            text: J,
                            level: 0,
                            children: [],
                            label: J
                ...
                p(E);
                var Q;
                if (l.colTotals) for (var R = f.length; R--;) for (s = t; s < e.length; s++) Q = e[s].name,
                g[Q] ? g[Q] += parseFloat(f[R][Q] || 0) : g[Q] = parseFloat(f[R][Q] || 0);
    ...
    a.extend(a.jgrid, {
            ...
            c || {}), b) {
                ...
                if (h.grid) {
                    ...
                    if (a.isFunction(c.beforeSetItem) && null != (d = c.beforeSetItem.call(h, f)) && (f = d), c.debug) {
                        ...
                        a("#link_save").attr("href", k).on("click",
                        function() {
                            a(this).remove()
                        })
                    }
            ...
            d || {}), b) {
                ...
                if (c) {
                    ...
                    if ((e = a.jgrid.parseFunc(c)) && "object" === a.type(e)) {
                        ...
                        a.isFunction(d.beforeSetGrid) && (f = d.beforeSetGrid(e)) && "object" === a.type(f) && (e = f);
                        var k = function(a) {
                            return a
                        },
                        l = {
                        ...
                        e.filterToolbar && (i = k(e._fT), e._fT = null, delete e._fT);
                        var m = a("#" + b).jqGrid(e);
                        if (d.restoreData && "" !== a.trim(g) && m.append(g), m.jqGrid("setGridParam", l), e.storeNavOptions && e.navGrid && (m[0].p.navGrid = !1, m.jqGrid("navGrid", e.pager, e.navOptions, e.editOptions, e.addOptions, e.delOptions, e.searchOptions, e.viewOptions), e.navButtons && e.navButtons.length)) for (var n = 0; n < e.navButtons.length; n++)"sepclass" in e.navButtons[n][1] ? m.jqGrid("navSeparatorAdd", e.navButtons[n][0], e.navButtons[n][1]) : m.jqGrid("navButtonAdd", e.navButtons[n][0], e.navButtons[n][1]);
                        ...
                        if (e.treeGrid) for (var q = 1,
                        r = m[0].rows.length, s = e.expColInd, t = e.treeReader.leaf_field, u = e.treeReader.expanded_field; q < r;) a(m[0].rows[q].cells[s]).find("div.treeclick").on("click",
                        function(b) {
                            var c = b.target || b.srcElement,
                            d = a.jgrid.stripPref(e.idPrefix, a(c, m[0].rows).closest("tr.jqgrow")[0].id),
                            f = m[0].p._index[d];
                            return m[0].p.data[f][t] || (m[0].p.data[f][u] ? (m.jqGrid("collapseRow", m[0].p.data[f]), m.jqGrid("collapseNode", m[0].p.data[f])) : (m.jqGrid("expandRow", m[0].p.data[f]), m.jqGrid("expandNode", m[0].p.data[f]))),
                            !1
                        }),
                        !0 === e.ExpandColClick && a(m[0].rows[q].cells[s]).find("span.cell-wrapper").css("cursor", "pointer").on("click",
                        function(b) {
                            var c = b.target || b.srcElement,
                            d = a.jgrid.stripPref(e.idPrefix, a(c, m[0].rows).closest("tr.jqgrow")[0].id),
                            f = m[0].p._index[d];
                        ...
                        q++;
                        e.multiselect && a.each(e.selarrrow,
                        function() {
                        ...
                        e.filterToolbar && i && (m.jqGrid("setGridParam", {
                            filterToolbar: !1
                        }), i.restoreFromFilters = !0, m.jqGrid("filterToolbar", i)),
        ...
        setRegional: function(b, c) {
            ...
            if (d = a.extend(d, c || {}), d.regional) {
                ...
                a.each(f,
                function(a) {
                    if (this.formatter && "actions" === this.formatter) return g = a,
                    !1
                }),
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    if ("remote" === b.exptype) {
                        ...
                        if (b.exporthidden) {
                            var g, h = this.p.colModel,
                            i = h.length,
                            j = [];
                            for (g = 0; g < i; g++) void 0 === h[g].hidden && (h[g].hidden = !1),
                            j.push({
                                name: h[g].name,
                                hidden: h[g].hidden
                            });
                        ...
                        c = -1 !== b.url.indexOf("?") ? b.url + "&" + l: b.url + "?" + l,
                        window.location = c
                    }
                }
            })
...
function(a) {
    "use strict";
    "function" == typeof define && define.amd ? define(["jquery", "./grid.base", "./jquery.fmatter", "./grid.utils"], a) : a(jQuery)
} (function(a) {
    "use strict";
    a.jgrid = a.jgrid || {},
    a.extend(a.jgrid, {
        ...
        excelCellPos: function(a) {
            for (var b = "A".charCodeAt(0), c = "Z".charCodeAt(0), d = c - b + 1, e = ""; a >= 0;) e = String.fromCharCode(a % d + b) + e,
            a = Math.floor(a / d) - 1;
            return e
        },
        makeNode: function(b, c, d) {
            var e = b.createElement(c);
            return d && (d.attr && a(e).attr(d.attr), d.children && a.each(d.children,
            function(a, b) {
                e.appendChild(b)
        ...
        xmlToZip: function(b, c) {
            ...
            a.each(c,
            function(c, n) {
                if (a.isPlainObject(n)) d = b.folder(c),
                j.xmlToZip(d, n);
                else {
                    if (l) {
                        ...
                        for (f = 0, g = m.length; f < g; f++) h = n.createAttribute(m[f].name.replace(":", "_dt_b_namespace_token_")),
                        h.value = m[f].value,
                        e.setAttributeNode(h)
                    }
                    i = k.serializeToString(n),
                    l && ( - 1 === i.indexOf("<?xml") && (i = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + i), i = i.replace(/_dt_b_namespace_token_/g, ":")),
                    i = i.replace(/<row xmlns="" /g, "<row ").replace(/<cols xmlns="">/g, "<cols>").replace(/<mergeCells xmlns="" /g, "<mergeCells "),
                    b.file(c, i)
                }
            })
        },
            ...
            if (this.each(function() {
                function d(b, c) {
                    ...
                    function e(b, e, f, g) {
                        ...
                        p = 0;
                        for (i = g; i < n; i++) if (m[i].exportcol) {
                            var q = "{0}";
                            a.each(k.summary,
                            function() {
                                if (this.nm === m[i].name) {
                                    ...
                                    return o[p] = a.jgrid.formatCellCsv(a.jgrid.stripHtml(a.jgrid.template(q, h)), c),
                                    !1
                                }
                            }),
                            p++
                    ...
                    var p, q, r = a.makeArray(g.groupSummary);
                    ...
                    function(d, k) {
                        ...
                        var l = "";
                        "string" != typeof(l = a.isFunction(g.groupText[k.idx]) ? g.groupText[k.idx].call(j, p, k.cnt, k.summary) : a.jgrid.template(g.groupText[k.idx], p, k.cnt, k.summary)) && "number" != typeof l && (l = p);
                        var n;
                        if (n = "header" === g.groupSummaryPos[k.idx] ? e(d, 0, g.groups, 0) : new Array(c.collen), n[0] = a.jgrid.formatCellCsv(a.jgrid.stripHtml(l), c), f += n.join(c.separator) + c.newLine, i - 1 === k.idx) {
                            var s, t, u, v = g.groups[d + 1],
                            w = 0,
                            x = k.startRow,
                            y = void 0 !== v ? v.startRow: g.groups[d].startRow + g.groups[d].cnt;
                            for (s = x; s < y && b[s - w]; s++) {
                ...
                if (a.each(m,
                function(c, d) {
                    void 0 === d.exportcol && (d.hidden ? d.exportcol = !1 : d.exportcol = !0),
                    "cb" !== d.name && "rn" !== d.name && "subgrid" !== d.name || (d.exportcol = !1),
                    d.exportcol && (v.push(a.jgrid.formatCellCsv(o[c], b)), w.push(d.name))
                    ...
                    q += g.join(b.separator) + b.newLine,
                    p++
                }
                ...
                if (b.includeFooter && j.p.footerrow) {
                    if (a(".ui-jqgrid-ftable", this.sDiv).length) {
                        ...
                        for (e = 0, g = []; e < b.collen;) {
                            var B = w[e];
                            A.hasOwnProperty(B) && g.push(a.jgrid.formatCellCsv(a.jgrid.stripHtml(A[B]), b)),
                            e++
                        }
            ...
            this.each(function() {
                ...
                function d(b) {
                    ...
                    function d(b, d, f, h) {
                        ...
                        n = l.cnt,
                        p = e(o.header);
                        for (k = h; k < j; k++) if (m[k].exportcol) {
                            var q = "{0}";
                            a.each(l.summary,
                            function() {
                                if (this.nm === m[k].name) {
                                    ...
                                    return p[this.nm] = a.jgrid.stripHtml(a.jgrid.template(q, i)),
                                    !1
                                }
                            })
                        }
                    ...
                    var l, n = a.makeArray(f.groupSummary);
                    ...
                    function(c, j) {
                        ...
                        var m = "";
                        "string" != typeof(m = a.isFunction(f.groupText[j.idx]) ? f.groupText[j.idx].call(g, l, j.cnt, j.summary) : a.jgrid.template(f.groupText[j.idx], l, j.cnt, j.summary)) && "number" != typeof m && (m = l);
                        var p;
                        if (p = "header" === f.groupSummaryPos[j.idx] ? d(c, 0, f.groups, 0) : e(o.header), p[Object.keys(p)[0]] = a.jgrid.stripHtml(new Array(5 * j.idx).join(" ") + m), s(p, !0), i - 1 === j.idx) {
                            var q, r, t = f.groups[c + 1],
                            u = 0,
                            v = j.startRow,
                            w = void 0 !== t ? t.startRow: f.groups[c].startRow + f.groups[c].cnt;
                            for (q = v; q < w && b[q - u]; q++) {
                                var x = b[q - u];
                                s(x, !1)
                            }
                ...
                for (e = 0, f = m.length; e < f; e++) void 0 === m[e].exportcol && (m[e].hidden ? m[e].exportcol = !1 : m[e].exportcol = !0),
                "cb" !== m[e].name && "rn" !== m[e].name && "subgrid" !== m[e].name && m[e].exportcol && (o.header[n] = m[e].name, o.width[n] = 5, o.map[n] = e, n++);
                var p, q, r = a.isFunction(b.replaceStr) ? b.replaceStr: c,
                s = function(c, d) {
                    p = i + 1,
                    q = a.jgrid.makeNode(j, "row", {
                        attr: {
                            r: p
                        }
                    });
                    for (var e = 15,
                    f = 0; f < o.header.length; f++) {
                        var h, l, n = a.jgrid.excelCellPos(f) + "" + p,
                        s = a.isArray(c) && d ? g.p.colNames[o.map[f]] : c[o.header[f]];
                        null == s && (s = ""),
                        d || (s = a.jgrid.formatCell(s, o.map[f], c, m[o.map[f]], g, "excel")),
                        o.width[f] = Math.max(o.width[f], Math.min(parseInt(s.toString().length, 10), b.maxlength)),
                        s.match && (l = s.match(/^-?([1-9]\d+)(\.(\d+))?$/)),
                        h = null;
                        for (var t = 0,
                        u = a.jgrid.excelParsers.length; t < u; t++) {
                            var v = a.jgrid.excelParsers[t];
                            if (s.match && !s.match(/^0\d+/) && s.match(v.match)) {
                                s = s.replace(/[^\d\.\-]/g, ""),
                                v.fmt && (s = v.fmt(s)),
                                h = 67 === v.style ? a.jgrid.makeNode(j, "c", {
                                    attr: {
                                        t: "d",
                                        r: n,
                                        s: v.style
                ...
                if (a("sheets sheet", l.xl["workbook.xml"]).attr("name", b.sheetName), b.includeGroupHeader && g.p.groupHeader && g.p.groupHeader.length) {
                    ...
                    for (u = 0; u < v.length; u++) {
                        ...
                        for (x++, e = 0, e = 0; e < o.header.length; e++) {
                            t = o.header[e],
                            z[t] = "";
                            for (var A = 0; A < y.length; A++) if (y[A].startColumnName === t) {
                                z[t] = y[A].titleText;
                ...
                G = o.body.length; F < G; F++) s(o.body[F], !1);
                ...
                a.isFunction(b.onBeforeExport) && b.onBeforeExport(l),
                o = null;
                try {
                    var I = new JSZip,
                    J = {
                    ...
                    I.generateAsync ? I.generateAsync(J).then(function(c) {
                        a.jgrid.saveAs(c, b.fileName, {
                            type: b.mimetype
                        })
            ...
            this.each(function() {
                function c(b) {
                    ...
                    function e(b, c, e, g) {
                        ...
                        l = k.cnt,
                        n = f(m);
                        for (j = g; j < s; j++) if (q[j].exportcol) {
                            var o = "{0}";
                            a.each(k.summary,
                            function() {
                                if (this.nm === q[j].name) {
                                    ...
                                    return n[this.nm] = a.jgrid.stripHtml(a.jgrid.template(o, i)),
                                    !1
                                }
                            })
                        }
                    ...
                    var u, v = a.makeArray(g.groupSummary);
                    ...
                    function(d, k) {
                        ...
                        var l = "";
                        "string" != typeof(l = a.isFunction(g.groupText[k.idx]) ? g.groupText[k.idx].call(h, u, k.cnt, k.summary) : a.jgrid.template(g.groupText[k.idx], u, k.cnt, k.summary)) && "number" != typeof l && (l = u);
                        var n;
                        if (n = "header" === g.groupSummaryPos[k.idx] ? e(d, 0, g.groups, 0) : f(m), n[Object.keys(n)[0]] = a.jgrid.stripHtml(new Array(5 * k.idx).join(" ") + l), i.push(c(n, !1)), p - 1 === k.idx) {
                            var o, q, r = g.groups[d + 1],
                            s = 0,
                            w = k.startRow,
                            x = void 0 !== r ? r.startRow: g.groups[d].startRow + g.groups[d].cnt;
                            for (o = w; o < x && b[o - s]; o++) {
                                var y = b[o - s];
                                i.push(c(y, !0))
                            }
                ...
                q = [],
                r = {};
                for (d = 0, e = j.length; d < e; d++) void 0 === j[d].exportcol && (j[d].hidden ? j[d].exportcol = !1 : j[d].exportcol = !0),
                "cb" !== j[d].name && "rn" !== j[d].name && "subgrid" !== j[d].name && j[d].exportcol && (k = {
                    text: h.p.colNames[d],
                    style: "tableHeader"
                },
            ...
            return this.each(function() {
                function d(b) {
                    ...
                    function d(b, d, f, i) {
                        ...
                        o = n.cnt,
                        p = e(j.header);
                        for (m = i; m < l; m++) if (!h[m].hidden && h[m].exportcol) {
                            var q = "{0}";
                            a.each(n.summary,
                            function() {
                                if (this.nm === h[m].name) {
                                    ...
                                    return p[this.nm] = a.jgrid.stripHtml(a.jgrid.template(q, k)),
                                    !1
                                }
                            })
                        }
                    ...
                    var p, q = a.makeArray(f.groupSummary);
                    ...
                    function(c, h) {
                        ...
                        var l = "";
                        "string" != typeof(l = a.isFunction(f.groupText[h.idx]) ? f.groupText[h.idx].call(g, p, h.cnt, h.summary) : a.jgrid.template(f.groupText[h.idx], p, h.cnt, h.summary)) && "number" != typeof l && (l = p);
                        var r, s = !1;
                        if ("header" === f.groupSummaryPos[h.idx] ? r = d(c, 0, f.groups, 0) : (r = e(j.header), s = !0), r[Object.keys(r)[0]] = new Array(5 * h.idx).join(" ") + l, n += o(r, "td", !1, 1 === m, s), k - 1 === h.idx) {
                            var t, u, v = f.groups[c + 1],
                            w = 0,
                            x = h.startRow,
                            y = void 0 !== v ? v.startRow: f.groups[c].startRow + f.groups[c].cnt;
                            for (t = x; t < y && b[t - w]; t++) {
                                var z = b[t - w];
                                n += o(z, "td", !1)
                            }
                ...
                for (e = 0, f = h.length; e < f; e++) void 0 === h[e].exportcol && (h[e].exportcol = !0),
                !h[e].hidden && "cb" !== h[e].name && "rn" !== h[e].name && "subgrid" !== h[e].name && h[e].exportcol && (j.header[i] = h[e].name, j.width[i] = h[e].width, j.map[i] = e, j.align[i] = h[e].align || "left", i++);
                var k = document.createElement("a"),
                l = function(b) {
                    var c = a(b).clone()[0];
                    return "link" === c.nodeName.toLowerCase() && (c.href = m(c.href)),
                    c.outerHTML
                },
                m = function(a) {
                    k.href = a;
                    var b = k.host;
                    return - 1 === b.indexOf("/") && 0 !== k.pathname.indexOf("/") && (b += "/"),
                    k.protocol + "//" + b + k.pathname + k.search
                },
                n = function(a, b, c) {
                    for (var d, e = "<tr>",
                    f = 0,
                    h = a.length; f < h; f++) d = !0 === c ? " style=width:" + j.width[f] + "px;": "",
                    e += "<" + b + d + ">" + g.p.colNames[j.map[f]] + "</" + b + ">";
                    return e + "</tr>"
                },
                o = function(b, c, d, e, f) {
                    for (var i, k, l = "<tr>",
                    m = 0,
                    n = j.header.length; m < n && (k = f ? ' colspan= "' + j.header.length + '" style=text-align:left': !0 === e ? " style=width:" + j.width[m] + "px;text-align:" + j.align[m] + ";": " style=text-align:" + j.align[m] + ";", i = j.header[m], b.hasOwnProperty(i) && (l += "<" + c + k + ">" + (d ? a.jgrid.formatCell(b[i], j.map[m], b, h[j.map[m]], g, "html") : b[i]) + "</" + c + ">"), !f); m++);
                    return l + "</tr>"
                },
                ...
                f = j.body.length; i < f; i++) p += o(j.body[i], "td", !0, 0 === i);
                if (b.includeFooter && g.p.footerrow && (j.footer = a(g).jqGrid("footerData", "get", null, !1), p += o(j.footer, "td", !1)), p += "</tbody>", p += "</table>", b.returnAsString) c = p;
                else {
                    var r = window.open("", "");
                    r.document.close();
                    ...
                    r.document.body.innerHTML = (b.title ? "<h1>" + b.title + "</h1>": "") + "<div>" + (b.topText || "") + "</div>" + p + "<div>" + (b.bottomText || "") + "</div>",
                    ...
                    Boolean(r.chrome) ? b.autoPrint && (r.print(), r.close()) : setTimeout(function() {
            ...
            if (root) {
                ...
                parseElement = function(a) {
                    if (7 !== a.nodeType) {
                        ...
                        var b, c, d, e, f = {};
                        if (a.attributes && a.attributes.length) for (b = {},
                        c = 0; c < a.attributes.length; c++)"string" == typeof(d = a.attributes[c].nodeName) && (e = a.attributes[c].nodeValue) && (d = o.attr_prefix + d, void 0 === f[d] && (f[d] = 0), f[d]++, addNode(b, d, f[d], e));
                        if (a.childNodes && a.childNodes.length) {
                            ...
                            else for (b || (b = {}), c = 0; c < a.childNodes.length; c++)"string" == typeof(d = a.childNodes[c].nodeName) && (e = parseElement(a.childNodes[c])) && (void 0 === f[d] && (f[d] = 0), f[d]++, addNode(b, d, f[d], e))
                        }
                        return b
                    }
                },
    ...
    $.jgrid.extend({
        sortableColumns: function(a) {
            return this.each(function() {
                function b() {
                    d.p.disableClick = !0,
                    d.p.frozenColumns && ($(d).jqGrid("destroyFrozenColumns"), f = !0)
                }
                function c() {
                    setTimeout(function() {
                        d.p.disableClick = !1,
        ...
        columnChooser: function(a) {
            ...
            if (!$("#colchooser_" + $.jgrid.jqID(l[0].p.id)).length) {
                ...
                a.height && ($(">div", e).css("height", a.height), f.css("height", a.height - 10)),
                f.empty(),
                $.each(o,
                function(a) {
                            ...
                            return $.extend({
                                ...
                                drop: function(b, c) {
                                    if ($(c.draggable).hasClass("jqgrow")) {
                                        ...
                                        if (c.helper.dropped) {
                                            var o;
                                            a.autoid && ($.isFunction(a.autoid) ? o = a.autoid.call(h, e) : (o = Math.ceil(1e3 * Math.random()), o = a.autoidprefix + o)),
...
function(a) {
    ...
    a.fn.html5sortable = function(d) {
        ...
        this.each(function() {
            var f;
            if (/^enable|disable|destroy$/.test(e)) return f = a(this).children(a(this).data("items")).attr("draggable", "enable" === e),
            void("destroy" === e && f.add(this).removeData("connectWith items").off("dragstart.h5s dragend.h5s selectstart.h5s dragover.h5s dragenter.h5s drop.h5s"));
            var g, h;
            ...
            c = c.add(i),
            d.connectWith && a(d.connectWith).add(this).data("connectWith", d.connectWith),
            ...
            function() {
                ...
                !1
            }).end().add([this, i]).on("dragover.h5s dragenter.h5s drop.h5s",
            function(e) {
